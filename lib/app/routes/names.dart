...
abstract class PlugRoutesNames {
  ...
  static accountAdminVerify(String address, String type) =>
      '/accountAdmin/$address/$type';
  ...
  static chainVerifierDetail(String address, String type) =>
      '/chainVerifierDetail/$address/$type';
  static chainVerifierDetailNull(String address) =>
      '/chainVerifierDetailNull/$address/null';

  /// 生态-转质押
  static chainRePledge(String address) => '/chainVerifierRePledge/$address';

  /// 生态-赎回质押
  static chainBackupPledge(String address) =>
      '/chainVerifierBackupPledge/$address';
