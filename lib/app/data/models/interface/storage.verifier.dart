...
class VerifierModel extends _StorageBaseAbstract {
  ...
  set status(VerifierStatusEnum value) {
    _status = value;
    _saveKey();
  }
  ...
  set minPledgeVolume(String value) {
    _minPledgeVolume = value;
    _saveKey();
  }
  ...
  void setData(String sourceStr) {
    ...
    switch (source['status'] ?? VerifierStatusEnum.running) {
      ...
      case 'verifierStatusEnum.invalid':
        status = VerifierStatusEnum.invalid;
        break;
      default:
        status = VerifierStatusEnum.running;
        break;
...
class UserVerifierModel extends VerifierModel {
  ...
  void setData(String sourceStr) {
    ...
    avatar = source['avatar'] ??
        '${Env.envConfig.assets.verifierAvatarUrl}/default/image.png';
    avatar = source['nickName'] ?? '';
    avatar = source['address'] ?? '';
    avatar = source['yieldRate'] ?? '';
    avatar = source['cutRate'] ?? '';
