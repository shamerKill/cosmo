...
class ConfigAppData extends _StorageBaseAbstract {
  ...
  set safeDappView (bool value) { _safeDappView = value; _saveKey(); }
  bool _safeDappView = false;
  // 是否开启了生物识别
  bool get useBiometrics => _useBiometrics;
  set useBiometrics (bool value) { _useBiometrics = value; _saveKey(); }
  bool _useBiometrics = false;
  // 语言版本
  Locale? get languageType => _languageType;
  set languageType (Locale? value) { _languageType = value; _saveKey(); }
  Locale? _languageType;

  // 首页是显示或隐藏
  bool get homeValueHide => _homeValueHide;
  set homeValueHide (bool value) { _homeValueHide = value; _saveKey(); }
  ...
  void setData(String sourceStr) {
    ...
    languageType = source['languageType'] != null ? Locale.fromSubtags(languageCode: source['languageType']) : null;
