...
class AppColor {
  ...
  static ThemeColorClass get lightColors => ThemeColorClass(
        ...
        homeAddressBg: [const Color(0xFF000000), const Color(0xFF000000)],
        homeAssetsBg: [const Color(0xFF00CC66), const Color(0xFF00CC66)],
      );
  static ThemeColorClass get darkColors => ThemeColorClass(
        ...
        proposalAbandon: const Color(0xFFCFD5E5),
        homeAddressBg: [
          const Color(0xFF081327),
          const Color(0xFF060F19),
