...
class LAppBar {
  ...
  static Widget defaultHeaderTextWidget(String titleStr) => Text(titleStr,
      style: TextStyle(
          fontSize: appTheme.sizes.titleBarTitleSize,
  ...
  static Widget defaultHeader({
    ...
    Widget? _title =
        title ?? (titleStr != null ? defaultHeaderTextWidget(titleStr) : null);
    return SizedBox(
      ...
      child: Material(
        ...
        child: Stack(
          children: [
            ...
            if (_title != null) Center(child: _title),
            if (actions != null)
              Positioned(
                top: 0,
                right: 0,
