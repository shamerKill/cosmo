...
class ChainVerifierDetailInfoPage
    extends GetView<ChainVerifierDetailInfoPageController> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Padding(
                      padding:
                          EdgeInsets.only(bottom: appTheme.sizes.paddingSmall)),
                  DottedLine(
                      ...
                      children: [
                        ...
                        Text(
                            NumberTool.formatNumberStr(
                                ...
                                state.baseCoinInfo.symbol,
                            style:
                                TextStyle(color: appTheme.colors.primaryColor)),
                        Padding(
                            padding: EdgeInsets.only(
                                bottom: appTheme.sizes.paddingSmall)),
                        DottedLine(
