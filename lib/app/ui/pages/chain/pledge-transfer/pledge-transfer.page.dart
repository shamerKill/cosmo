                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(padding: EdgeInsets.only(top: appTheme.sizes.basic * 10.0)),
                        Text(NumberTool.formatNumberStr(state.veriferInfo.allPledged.toString()))
                      ],
                    ),
                  ),
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(padding: EdgeInsets.only(top: appTheme.sizes.basic * 10.0)),
                        Text(NumberTool.formatNumberStr(state.veriferInfo.minPledgVolume.toString()))
                      ],
                    ),
                  ),
                ],
                  ...
                  child: Obx(() => Text.rich(
                    TextSpan(
                      children: [
                        ...
                        const TextSpan(text: '  '),
                        TextSpan(
                          text: NumberTool.formatNumberStr(NumberTool.amountToBalance(state.baseCoinAmount, scale: state.baseCoin.scale)),
