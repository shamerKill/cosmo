...
class ChainPledgeTransferPage
    extends GetView<ChainPledgeTransferPageController> {
                      ...
                      children: [
                        ...
                        Padding(
                            padding: EdgeInsets.only(
                                top: appTheme.sizes.basic * 10.0)),
                        Obx(() => Text(NumberTool.formatNumberStr(
                            NumberTool.amountToBalance(state
                                .verifierInfo.minPledgeVolume
                                .toString()))))
                      ],
                    ),
                  ),
            ...
            child: Column(
              ...
              children: [
                ...
                LInput(
                  ...
                  obscureText: true,
                  suffix: Text(state.baseCoin.symbol,
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Obx(() => Text(
                          'pledgeTipList_1_1'.tr +
                              ' ${state.baseCoin.symbol} ' +
                              'pledgeTipList_1_2'.tr,
                          style: Get.textTheme.bodyText1)),
                      Padding(
                          padding: EdgeInsets.only(
                              top: appTheme.sizes.paddingSmall)),
                      Text('pledgeTipList_2'.tr,
                          style: Get.textTheme.bodyText1),
                    ],
                  ),
                ),
