...
class ChainPledgeTransferPageState {
  ...
  // 账户基础币数量
  final Rx<String> _baseCoinAmount = ''.obs;
  String get baseCoinAmount => _baseCoinAmount.value;
  set baseCoinAmount (String value) => _baseCoinAmount.value = value;
  // 手续费数量
...
class ChainPledgeTransferPageController extends GetxController {
  ...
  _initData() {
    state._veriferInfo.value..address = 'gxjioasdjfasldgkjoi123jioldsajfgolasdjgio'
      ...
      ..reward = '123124123'
      ..minPledgVolume = '10';
    state.baseCoin..symbol = 'PLUGCN' ..scale = 6;
    state.feeAmount = '200';
    state.baseCoinAmount = '10000';
  }
