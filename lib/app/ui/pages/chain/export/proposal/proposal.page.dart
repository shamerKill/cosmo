...
class ChainExportProposalPage
    extends GetView<ChainExportProposalPageController> {
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () =>
                                        controller.onGoToProposalDetail(_item),
                                    child: Column(
                                      crossAxisAlignment:
                                        ...
                                        Row(
                                          ...
                                          children: [
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    (_item.passedVolumeForVoting >
                                                                            _item
                                                                                .rejectedVolumeForVoting
                                                                        ? 'agree'
                                                                            .tr
                                                                        : (_item.passedVolumeForVoting ==
                                                                                _item.rejectedVolumeForVoting
                                                                            ? 'equilibrium'.tr
                                                                            : 'reject'.tr)),
                                                                  ),
                                                                ],
                                            ...
                                            Container(
                                              ...
                                              height:
                                                  appTheme.sizes.basic * 150,
                                              padding: EdgeInsets.all(
                                                  appTheme.sizes.paddingSmall),
                                              child: CustomPaint(
                                                painter: _VotingProgress(
                                                    info: _item),
                                              ),
                                            )
                                          ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      (_item.status ==
                                              EnumProposalStatus.votingPeriod
                                          ? InkWell(
                                              child: Icon(
                                                Icons.more_horiz,
                                                size: 28,
                                                color: _item.isOpenFunc
                          ...
                          Positioned(
                            ...
                            child: Container(
                              padding: EdgeInsets.symmetric(
                                  horizontal: appTheme.sizes.paddingSmall * 0.5,
...
class _VotingProgress extends CustomPainter {
  _VotingProgress({
    ...
    double allVolume = info.abandonVolumeForVoting +
        info.passedVolumeForVoting +
        info.rejectedVolumeForVoting;
    _agreeRatePi = (info.passedVolumeForVoting / allVolume) * (3.1415926 * 2);
    _abandonRatePi =
        (info.abandonVolumeForVoting / allVolume) * (3.1415926 * 2);
    _rejectRatePi =
        (info.rejectedVolumeForVoting / allVolume) * (3.1415926 * 2);
  }
  ...
  paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
        rect, _abandonRatePi + _agreeRatePi, _rejectRatePi, false, ratePaint);
  }
