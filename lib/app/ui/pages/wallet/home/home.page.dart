      ...
      state.tipBackupView.add(Column(
        children: [
          Padding(
            ...
            child: Text('backupMnemonicTipForSafeTitle'.tr,
                style: TextStyle(
          ...
          Padding(
            ...
            child: Text('backupMnemonicTipForSafeTip_1'.tr,
                style: Get.textTheme.bodyText1),
          ),
          Padding(
            padding: EdgeInsets.only(bottom: appTheme.sizes.paddingSmall),
            child: Text('backupMnemonicTipForSafeTip_2'.tr,
                style: Get.textTheme.bodyText1),
          ),
          Padding(
            ...
            child: Row(
              children: [
                ...
                Padding(
                    padding: EdgeInsets.only(right: appTheme.sizes.padding)),
                Expanded(
                  flex: 1,
                  child: LButton(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Obx(() => Container(
                            ...
                            decoration: BoxDecoration(
                                color: state.hadNewsTip
                                    ? appTheme.colors.errorColor
                                    : null,
                                borderRadius: BorderRadius.all(Radius.circular(
                                    appTheme.sizes.basic * 14))),
                          )),
                    ),
                  ],
                ),
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Obx(() => TextButton(
                            onPressed: (state.drawerSelected != '' &&
                                    state.accountInfo.address !=
                                        state.drawerSelected)
                                ? () => controller
                                    .onChangeAccount(state.drawerSelected)
                                : null,
                            child: Text('selectToNowAccount'.tr,
                                style: TextStyle(
                                    fontSize: appTheme.sizes.fontSizeSmall,
                                    color: (state.drawerSelected != '' &&
                                            state.accountInfo.address !=
                                                state.drawerSelected)
                                        ? null
                                        : appTheme.colors.textGray)),
                          )),
                      Obx(() => TextButton(
                            onPressed: state.drawerSelected != ''
                                ? () => controller
                                    .onAdminAccount(state.drawerSelected)
                                : null,
                            child: Opacity(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: appTheme.sizes.fontSize * 0.2),
                                    child: Icon(
                                        const IconData(0xe6da,
                                            fontFamily: 'plugIcon'),
                    ...
                    child: SingleChildScrollView(
                      child: Obx(() => Column(
                            children: state.accountList
                                .map<Widget>((_item) => Padding(
                                      padding: EdgeInsets.only(
                                          top: appTheme.sizes.padding),
                                      child: InkWell(
                                        onTap: () => controller
                                            .onDrawerSelect(_item.address),
                                        onLongPress: () =>
                                            controller.onCopyAddress(
                  ...
                  Center(
                    child: Text('maxAccountLength'.tr,
                        style: Get.textTheme.bodyText1),
                  ),
                ],
              ),
            ...
            child: Column(
              children: [
                ...
                Builder(builder: (BuildContext _context) {
                  ...
                  var _contextColor =
                      appTheme.colors.hightColor.withOpacity(0.6);
                  return Stack(
                    children: [
                      // 余额
                      Container(
                        decoration:
                            _getBoxDecoration(appTheme.colors.homeAssetsBg),
                        child: Column(
                          children: [
                            ...
                            Obx(() => Container(
                                  height: appTheme.sizes.basic *
                                      210.0 *
                                      (state.infoBoxHeightScale / 100.0),
                                  padding: EdgeInsets.symmetric(
                                                    ...
                                                    TextSpan(
                                                      children: _balance == ''
                                                          ...
                                                          : [
                                                              ...
                                                              TextSpan(
                                                                  text:
                                                                      '\r${state.accountInfo.tokenList.first.symbol}'),
                                                            ],
                                                    ),
                                                    style: TextStyle(
                                                      fontSize: appTheme
                                            ...
                                            Obx(() => LAnimationView(
                                                ...
                                                child: Text(
                                                  state.accountAssetsPrice == ''
                                                      ? ''
                                                      : '≈\r\$${NumberTool.formatNumberStr(state.accountAssetsPrice)}',
                                                  style: TextStyle(
                                                    height: 2.5,
                                                    color: appTheme
                                                        .colors.hightColor,
                      ...
                      Positioned(
                        child: Container(
                          ...
                          padding: EdgeInsets.only(
                              left: appTheme.sizes.paddingSmall),
                          decoration:
                              _getBoxDecoration(appTheme.colors.homeAddressBg),
                          child: Row(
                            children: [
                              Expanded(
                                flex: 4,
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: Icon(const IconData(0xe6d6, fontFamily: 'plugIcon'),
                          color: appTheme.colors.textGray),
                      padding: EdgeInsets.only(
                          left: appTheme.sizes.paddingSmall,
                ...
                Obx(() => Column(
                      children: state.accountInfo.tokenList
                          .map(
                            (_item) => Padding(
                                padding: EdgeInsets.only(
                                    bottom: appTheme.sizes.paddingSmall),
                                            ...
                                            LAnimationView(
                                              ...
                                              child: Text(
                                                state.hideInfo
                                                    ? NumberTool
                                                        .getNumberLenStar(6)
                                                    : '≈\r\$${NumberTool.formatNumberStr(NumberTool.numMul(NumberTool.amountToBalance(_item.amount, scale: _item.scale), _item.price))}',
                                                style: Get.textTheme.bodyText1,
                                              ),
                                            ),
                                          ],
