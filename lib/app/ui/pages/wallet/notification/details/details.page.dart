...
class WalletNotificationDetailsPage
    extends GetView<WalletNotificationDetailsPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return LScaffold(
      ...
      titleBar: LAppBar.defaultTitle(
        title: Obx(() =>
            LAppBar.defaultHeaderTextWidget(state.notificationInfo.title)),
        description: Obx(() => Text(state.notificationInfo.time ?? '',
            style: Get.textTheme.bodyText1)),
      ),
      body: Obx(() => state.notificationContext == ''
          ? Container()
          : WebView(
