...
class UserAddressBookListPage
    extends GetView<UserAddressBookListPageController> {
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border(
                          bottom:
                              BorderSide(color: appTheme.colors.borderColor)),
                    ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.all(
                                Radius.circular(appTheme.sizes.radius / 2)),
                          ),
                          child: Text('remark'.tr + ': ' + _item.remarks,
                              style: Get.textTheme.bodyText1),
                        ),
                      ],
                    ),
