      ...
      headerBar: LAppBar.defaultHeader(
          actions: Obx(() => TextButton(
                onPressed: state.drawerSelected != ''
                    ? () => controller.onAdminAccount(state.drawerSelected)
                    : null,
                child: Opacity(
                    ...
                    child: LAnimationView(
                      ...
                      child: Container(
                        padding: EdgeInsets.symmetric(
                            ...
                            vertical: appTheme.sizes.padding * 1.2),
                          ...
                          gradient: LinearGradient(
                            colors: [
                              ...
                              StringTool.stringToColor(_item.address)
                                ...
                                state.drawerSelected == _item.address ? 1 : -1),
                          ),
                          borderRadius: BorderRadius.all(
                              Radius.circular(appTheme.sizes.radius)),
                          border: Border.all(
                              color: state.drawerSelected == _item.address
                                  ? appTheme.colors.primaryColor
                                  : appTheme.colors.transparent,
                              width: appTheme.sizes.basic * 4),
                        ),
                        child: Row(
                          children: [
                            Expanded(
                            ...
                            Icon(const IconData(0xe815, fontFamily: 'plugIcon'),
                                color: appTheme.colors.hightColor),
                          ],
                        ),
                      ),
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('addAccount'.tr),
                          Icon(const IconData(0xe6d6, fontFamily: 'plugIcon'),
