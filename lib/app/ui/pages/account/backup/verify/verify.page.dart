...
// TODO: 选择验证
class AccountBackupVerifyPage
    extends GetView<AccountBackupVerifyPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return LScaffold(
      ...
      titleBar: LAppBar.defaultTitle(
        ...
        description:
            Text('verifyMnemonicListDesc'.tr, style: Get.textTheme.bodyText1),
      ),
      singleScroll: true,
      body: Column(
        children: [
          ...
          SingleChildScrollView(
            child: Obx(() => Container(
                  ...
                  padding: state.mnemonicSelectList.isEmpty
                      ? null
                      : EdgeInsets.all(appTheme.sizes.padding),
                  ...
                  child: LAnimationView(
                    child: Wrap(
                      spacing: appTheme.sizes.paddingSmall,
                      runSpacing: appTheme.sizes.paddingSmall,
                      children: state.mnemonicSelectList
                          .map((item) => Container(
                                padding:
