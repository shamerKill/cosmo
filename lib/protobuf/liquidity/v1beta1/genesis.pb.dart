...
class PoolRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PoolRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.liquidity.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$3.PoolMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'poolMetadata', subBuilder: $3.PoolMetadata.create)
    ..aOM<$3.PoolBatch>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'poolBatch', subBuilder: $3.PoolBatch.create)
    ..pc<$3.DepositMsgState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'depositMsgStates', $pb.PbFieldType.PM, subBuilder: $3.DepositMsgState.create)
    ..pc<$3.WithdrawMsgState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'withdrawMsgStates', $pb.PbFieldType.PM, subBuilder: $3.WithdrawMsgState.create)
    ..pc<$3.SwapMsgState>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'swapMsgStates', $pb.PbFieldType.PM, subBuilder: $3.SwapMsgState.create)
  ...
  @$pb.TagNumber(2)
  set poolMetadata($3.PoolMetadata v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set poolBatch($3.PoolBatch v) { setField(3, v); }
  @$pb.TagNumber(3)
