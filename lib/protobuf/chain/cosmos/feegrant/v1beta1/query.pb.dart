...
class QueryApi {
  ...
  $async.Future<QueryAllowanceResponse> allowance(
      $pb.ClientContext? ctx, QueryAllowanceRequest request) {
    var emptyResponse = QueryAllowanceResponse();
    return _client.invoke<QueryAllowanceResponse>(
        ctx, 'Query', 'Allowance', request, emptyResponse);
  }

  $async.Future<QueryAllowancesResponse> allowances(
      $pb.ClientContext? ctx, QueryAllowancesRequest request) {
    var emptyResponse = QueryAllowancesResponse();
    return _client.invoke<QueryAllowancesResponse>(
        ctx, 'Query', 'Allowances', request, emptyResponse);
  }
}
