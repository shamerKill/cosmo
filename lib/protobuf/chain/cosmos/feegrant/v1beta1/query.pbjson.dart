...
final $typed_data.Uint8List queryAllowanceRequestDescriptor = $convert.base64Decode(
    'ChVRdWVyeUFsbG93YW5jZVJlcXVlc3QSGAoHZ3JhbnRlchgBIAEoCVIHZ3JhbnRlchIYCgdncmFudGVlGAIgASgJUgdncmFudGVl');
...
final $typed_data.Uint8List queryAllowanceResponseDescriptor =
    $convert.base64Decode(
        'ChZRdWVyeUFsbG93YW5jZVJlc3BvbnNlEjwKCWFsbG93YW5jZRgBIAEoCzIeLmNvc21vcy5mZWVncmFudC52MWJldGExLkdyYW50UglhbGxvd2FuY2U=');
...
final $typed_data.Uint8List queryAllowancesRequestDescriptor =
    $convert.base64Decode(
        'ChZRdWVyeUFsbG93YW5jZXNSZXF1ZXN0EhgKB2dyYW50ZWUYASABKAlSB2dyYW50ZWUSRgoKcGFnaW5hdGlvbhgCIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryAllowancesResponseDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeUFsbG93YW5jZXNSZXNwb25zZRI+CgphbGxvd2FuY2VzGAEgAygLMh4uY29zbW9zLmZlZWdyYW50LnYxYmV0YTEuR3JhbnRSCmFsbG93YW5jZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  '1': 'Query',
  '2': const [
    const {
      '1': 'Allowance',
      '2': '.cosmos.feegrant.v1beta1.QueryAllowanceRequest',
      '3': '.cosmos.feegrant.v1beta1.QueryAllowanceResponse',
      '4': const {}
    },
    const {
      '1': 'Allowances',
      '2': '.cosmos.feegrant.v1beta1.QueryAllowancesRequest',
      '3': '.cosmos.feegrant.v1beta1.QueryAllowancesResponse',
      '4': const {}
    },
  ],
};
