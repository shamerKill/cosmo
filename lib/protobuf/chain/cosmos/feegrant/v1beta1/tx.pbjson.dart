...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'GrantAllowance', '2': '.cosmos.feegrant.v1beta1.MsgGrantAllowance', '3': '.cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse'},
    const {'1': 'RevokeAllowance', '2': '.cosmos.feegrant.v1beta1.MsgRevokeAllowance', '3': '.cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  ...
  '.cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse': MsgGrantAllowanceResponse$json,
  '.cosmos.feegrant.v1beta1.MsgRevokeAllowance': MsgRevokeAllowance$json,
  '.cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse': MsgRevokeAllowanceResponse$json,
};

/// Descriptor for `Msg`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('');
