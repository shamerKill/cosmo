...
class MsgApi {
  ...
  $async.Future<MsgGrantAllowanceResponse> grantAllowance($pb.ClientContext? ctx, MsgGrantAllowance request) {
    var emptyResponse = MsgGrantAllowanceResponse();
    return _client.invoke<MsgGrantAllowanceResponse>(ctx, 'Msg', 'GrantAllowance', request, emptyResponse);
  }
  $async.Future<MsgRevokeAllowanceResponse> revokeAllowance($pb.ClientContext? ctx, MsgRevokeAllowance request) {
    var emptyResponse = MsgRevokeAllowanceResponse();
    return _client.invoke<MsgRevokeAllowanceResponse>(ctx, 'Msg', 'RevokeAllowance', request, emptyResponse);
  }
}
