...
class MsgFundCommunityPool extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$9.Coin> get amount => $_getList(0);
...
class MsgApi {
  ...
  $async.Future<MsgSetWithdrawAddressResponse> setWithdrawAddress(
      $pb.ClientContext? ctx, MsgSetWithdrawAddress request) {
    var emptyResponse = MsgSetWithdrawAddressResponse();
    return _client.invoke<MsgSetWithdrawAddressResponse>(
        ctx, 'Msg', 'SetWithdrawAddress', request, emptyResponse);
  }

  $async.Future<MsgWithdrawDelegatorRewardResponse> withdrawDelegatorReward(
      $pb.ClientContext? ctx, MsgWithdrawDelegatorReward request) {
    var emptyResponse = MsgWithdrawDelegatorRewardResponse();
    return _client.invoke<MsgWithdrawDelegatorRewardResponse>(
        ctx, 'Msg', 'WithdrawDelegatorReward', request, emptyResponse);
  }

  $async.Future<MsgWithdrawValidatorCommissionResponse>
      withdrawValidatorCommission(
          $pb.ClientContext? ctx, MsgWithdrawValidatorCommission request) {
    var emptyResponse = MsgWithdrawValidatorCommissionResponse();
    return _client.invoke<MsgWithdrawValidatorCommissionResponse>(
        ctx, 'Msg', 'WithdrawValidatorCommission', request, emptyResponse);
  }

  $async.Future<MsgFundCommunityPoolResponse> fundCommunityPool(
      $pb.ClientContext? ctx, MsgFundCommunityPool request) {
    var emptyResponse = MsgFundCommunityPoolResponse();
    return _client.invoke<MsgFundCommunityPoolResponse>(
        ctx, 'Msg', 'FundCommunityPool', request, emptyResponse);
  }
}
