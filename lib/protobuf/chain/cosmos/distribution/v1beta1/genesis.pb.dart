...
class ValidatorAccumulatedCommissionRecord extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set accumulated($25.ValidatorAccumulatedCommission v) {
    setField(2, v);
  }
...
class ValidatorHistoricalRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$25.ValidatorHistoricalRewards>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: $25.ValidatorHistoricalRewards.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set rewards($25.ValidatorHistoricalRewards v) {
    setField(3, v);
  }
...
class ValidatorCurrentRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<$25.ValidatorCurrentRewards>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: $25.ValidatorCurrentRewards.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set rewards($25.ValidatorCurrentRewards v) {
    setField(2, v);
  }
...
class DelegatorStartingInfoRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<$25.DelegatorStartingInfo>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'startingInfo',
        subBuilder: $25.DelegatorStartingInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set startingInfo($25.DelegatorStartingInfo v) {
    setField(3, v);
  }
...
class ValidatorSlashEventRecord extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set validatorSlashEvent($25.ValidatorSlashEvent v) {
    setField(4, v);
  }
