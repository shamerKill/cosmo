...
class ValidatorOutstandingRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorOutstandingRewardsRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$9.DecCoin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outstandingRewards', $pb.PbFieldType.PM, subBuilder: $9.DecCoin.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ValidatorOutstandingRewardsRecord({
    ...
    $core.Iterable<$9.DecCoin>? outstandingRewards,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(2)
  $core.List<$9.DecCoin> get outstandingRewards => $_getList(1);
}
...
class ValidatorAccumulatedCommissionRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorAccumulatedCommissionRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorAddress')
    ..aOM<$25.ValidatorAccumulatedCommission>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accumulated', subBuilder: $25.ValidatorAccumulatedCommission.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ValidatorAccumulatedCommissionRecord({
    $core.String? validatorAddress,
    $25.ValidatorAccumulatedCommission? accumulated,
  }) {
    final _result = create();
    if (validatorAddress != null) {
      _result.validatorAddress = validatorAddress;
  ...
  @$pb.TagNumber(2)
  $25.ValidatorAccumulatedCommission get accumulated => $_getN(1);
  @$pb.TagNumber(2)
  set accumulated($25.ValidatorAccumulatedCommission v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAccumulated() => $_has(1);
  @$pb.TagNumber(2)
  void clearAccumulated() => clearField(2);
  @$pb.TagNumber(2)
  $25.ValidatorAccumulatedCommission ensureAccumulated() => $_ensure(1);
}
...
class ValidatorHistoricalRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorHistoricalRewardsRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$25.ValidatorHistoricalRewards>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rewards', subBuilder: $25.ValidatorHistoricalRewards.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ValidatorHistoricalRewardsRecord({
    $core.String? validatorAddress,
    $fixnum.Int64? period,
    $25.ValidatorHistoricalRewards? rewards,
  }) {
    final _result = create();
    if (validatorAddress != null) {
      _result.validatorAddress = validatorAddress;
  ...
  @$pb.TagNumber(3)
  $25.ValidatorHistoricalRewards get rewards => $_getN(2);
  @$pb.TagNumber(3)
  set rewards($25.ValidatorHistoricalRewards v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRewards() => $_has(2);
  @$pb.TagNumber(3)
  void clearRewards() => clearField(3);
  @$pb.TagNumber(3)
  $25.ValidatorHistoricalRewards ensureRewards() => $_ensure(2);
}
...
class ValidatorCurrentRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorCurrentRewardsRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorAddress')
    ..aOM<$25.ValidatorCurrentRewards>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rewards', subBuilder: $25.ValidatorCurrentRewards.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ValidatorCurrentRewardsRecord({
    $core.String? validatorAddress,
    $25.ValidatorCurrentRewards? rewards,
  }) {
    final _result = create();
    if (validatorAddress != null) {
      _result.validatorAddress = validatorAddress;
  ...
  @$pb.TagNumber(2)
  $25.ValidatorCurrentRewards get rewards => $_getN(1);
  @$pb.TagNumber(2)
  set rewards($25.ValidatorCurrentRewards v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRewards() => $_has(1);
  @$pb.TagNumber(2)
  void clearRewards() => clearField(2);
  @$pb.TagNumber(2)
  $25.ValidatorCurrentRewards ensureRewards() => $_ensure(1);
}
...
class DelegatorStartingInfoRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DelegatorStartingInfoRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$25.DelegatorStartingInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startingInfo', subBuilder: $25.DelegatorStartingInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory DelegatorStartingInfoRecord({
    $core.String? delegatorAddress,
    $core.String? validatorAddress,
    $25.DelegatorStartingInfo? startingInfo,
  }) {
    final _result = create();
    if (delegatorAddress != null) {
      _result.delegatorAddress = delegatorAddress;
  ...
  @$pb.TagNumber(3)
  $25.DelegatorStartingInfo get startingInfo => $_getN(2);
  @$pb.TagNumber(3)
  set startingInfo($25.DelegatorStartingInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStartingInfo() => $_has(2);
  @$pb.TagNumber(3)
  void clearStartingInfo() => clearField(3);
  @$pb.TagNumber(3)
  $25.DelegatorStartingInfo ensureStartingInfo() => $_ensure(2);
}
...
class ValidatorSlashEventRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidatorSlashEventRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$25.ValidatorSlashEvent>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorSlashEvent', subBuilder: $25.ValidatorSlashEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ValidatorSlashEventRecord({
    ...
    $fixnum.Int64? height,
    $fixnum.Int64? period,
    $25.ValidatorSlashEvent? validatorSlashEvent,
  }) {
    final _result = create();
    if (validatorAddress != null) {
      _result.validatorAddress = validatorAddress;
  ...
  @$pb.TagNumber(4)
  $25.ValidatorSlashEvent get validatorSlashEvent => $_getN(3);
  @$pb.TagNumber(4)
  set validatorSlashEvent($25.ValidatorSlashEvent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValidatorSlashEvent() => $_has(3);
  @$pb.TagNumber(4)
  void clearValidatorSlashEvent() => clearField(4);
  @$pb.TagNumber(4)
  $25.ValidatorSlashEvent ensureValidatorSlashEvent() => $_ensure(3);
}
...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..aOM<$25.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $25.Params.create)
    ..aOM<$25.FeePool>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feePool', subBuilder: $25.FeePool.create)
  ...
  @$pb.TagNumber(2)
  $25.FeePool get feePool => $_getN(1);
  @$pb.TagNumber(2)
  set feePool($25.FeePool v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeePool() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeePool() => clearField(2);
  @$pb.TagNumber(2)
  $25.FeePool ensureFeePool() => $_ensure(1);
