...
import 'distribution.pb.dart' as $25;
import '../../base/query/v1beta1/pagination.pb.dart' as $2;
import '../../base/v1beta1/coin.pb.dart' as $9;
...
class QueryValidatorOutstandingRewardsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$25.ValidatorOutstandingRewards>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: $25.ValidatorOutstandingRewards.create)
    ..hasRequiredFields = false;

  QueryValidatorOutstandingRewardsResponse._() : super();
  factory QueryValidatorOutstandingRewardsResponse({
    $25.ValidatorOutstandingRewards? rewards,
  }) {
    final _result = create();
    if (rewards != null) {
  ...
  @$pb.TagNumber(1)
  $25.ValidatorOutstandingRewards get rewards => $_getN(0);
  @$pb.TagNumber(1)
  set rewards($25.ValidatorOutstandingRewards v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $25.ValidatorOutstandingRewards ensureRewards() => $_ensure(0);
}
...
class QueryValidatorCommissionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$25.ValidatorAccumulatedCommission>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'commission',
        subBuilder: $25.ValidatorAccumulatedCommission.create)
    ..hasRequiredFields = false;

  QueryValidatorCommissionResponse._() : super();
  factory QueryValidatorCommissionResponse({
    $25.ValidatorAccumulatedCommission? commission,
  }) {
    final _result = create();
    if (commission != null) {
  ...
  @$pb.TagNumber(1)
  $25.ValidatorAccumulatedCommission get commission => $_getN(0);
  @$pb.TagNumber(1)
  set commission($25.ValidatorAccumulatedCommission v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $25.ValidatorAccumulatedCommission ensureCommission() => $_ensure(0);
}
...
class QueryValidatorSlashesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..pc<$25.ValidatorSlashEvent>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'slashes',
        $pb.PbFieldType.PM,
        subBuilder: $25.ValidatorSlashEvent.create)
    ..aOM<$2.PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryValidatorSlashesResponse({
    $core.Iterable<$25.ValidatorSlashEvent>? slashes,
  ...
  @$pb.TagNumber(1)
  $core.List<$25.ValidatorSlashEvent> get slashes => $_getList(0);
...
class QueryDelegationRewardsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$9.DecCoin> get rewards => $_getList(0);
}
...
class QueryDelegationTotalRewardsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..pc<$25.DelegationDelegatorReward>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        $pb.PbFieldType.PM,
        subBuilder: $25.DelegationDelegatorReward.create)
    ..pc<$9.DecCoin>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryDelegationTotalRewardsResponse({
    $core.Iterable<$25.DelegationDelegatorReward>? rewards,
    $core.Iterable<$9.DecCoin>? total,
  }) {
    final _result = create();
    if (rewards != null) {
      _result.rewards.addAll(rewards);
  ...
  @$pb.TagNumber(1)
  $core.List<$25.DelegationDelegatorReward> get rewards => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$9.DecCoin> get total => $_getList(1);
}
...
class QueryCommunityPoolResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$9.DecCoin> get pool => $_getList(0);
}
...
class QueryApi {
  ...
  $async.Future<QueryValidatorOutstandingRewardsResponse>
      validatorOutstandingRewards($pb.ClientContext? ctx,
          QueryValidatorOutstandingRewardsRequest request) {
    var emptyResponse = QueryValidatorOutstandingRewardsResponse();
    return _client.invoke<QueryValidatorOutstandingRewardsResponse>(
        ctx, 'Query', 'ValidatorOutstandingRewards', request, emptyResponse);
  }

  $async.Future<QueryValidatorCommissionResponse> validatorCommission(
      $pb.ClientContext? ctx, QueryValidatorCommissionRequest request) {
    var emptyResponse = QueryValidatorCommissionResponse();
    return _client.invoke<QueryValidatorCommissionResponse>(
        ctx, 'Query', 'ValidatorCommission', request, emptyResponse);
  }

  $async.Future<QueryValidatorSlashesResponse> validatorSlashes(
      $pb.ClientContext? ctx, QueryValidatorSlashesRequest request) {
    var emptyResponse = QueryValidatorSlashesResponse();
    return _client.invoke<QueryValidatorSlashesResponse>(
        ctx, 'Query', 'ValidatorSlashes', request, emptyResponse);
  }

  $async.Future<QueryDelegationRewardsResponse> delegationRewards(
      $pb.ClientContext? ctx, QueryDelegationRewardsRequest request) {
    var emptyResponse = QueryDelegationRewardsResponse();
    return _client.invoke<QueryDelegationRewardsResponse>(
        ctx, 'Query', 'DelegationRewards', request, emptyResponse);
  }

  $async.Future<QueryDelegationTotalRewardsResponse> delegationTotalRewards(
      $pb.ClientContext? ctx, QueryDelegationTotalRewardsRequest request) {
    var emptyResponse = QueryDelegationTotalRewardsResponse();
    return _client.invoke<QueryDelegationTotalRewardsResponse>(
        ctx, 'Query', 'DelegationTotalRewards', request, emptyResponse);
  }
  ...
  $async.Future<QueryDelegatorWithdrawAddressResponse> delegatorWithdrawAddress(
      $pb.ClientContext? ctx, QueryDelegatorWithdrawAddressRequest request) {
    var emptyResponse = QueryDelegatorWithdrawAddressResponse();
    return _client.invoke<QueryDelegatorWithdrawAddressResponse>(
        ctx, 'Query', 'DelegatorWithdrawAddress', request, emptyResponse);
  }

  $async.Future<QueryCommunityPoolResponse> communityPool(
      $pb.ClientContext? ctx, QueryCommunityPoolRequest request) {
    var emptyResponse = QueryCommunityPoolResponse();
    return _client.invoke<QueryCommunityPoolResponse>(
        ctx, 'Query', 'CommunityPool', request, emptyResponse);
  }
}
