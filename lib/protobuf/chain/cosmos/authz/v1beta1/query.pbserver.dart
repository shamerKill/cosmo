...
abstract class QueryServiceBase extends $pb.GeneratedService {
  $async.Future<$6.QueryGrantsResponse> grants(
      $pb.ServerContext ctx, $6.QueryGrantsRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'Grants':
        return $6.QueryGrantsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'Grants':
        return this.grants(ctx, request as $6.QueryGrantsRequest);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
