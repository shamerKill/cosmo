  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$34.VoteOption>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'option',
        $pb.PbFieldType.OE,
        defaultOrMaker: $34.VoteOption.VOTE_OPTION_UNSPECIFIED,
        valueOf: $34.VoteOption.valueOf,
        enumValues: $34.VoteOption.values)
    ..hasRequiredFields = false;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'voter')
    ..pc<$34.WeightedVoteOption>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'options',
        $pb.PbFieldType.PM,
        subBuilder: $34.WeightedVoteOption.create)
    ..hasRequiredFields = false;
...
class MsgApi {
  ...
  $async.Future<MsgSubmitProposalResponse> submitProposal(
      $pb.ClientContext? ctx, MsgSubmitProposal request) {
    var emptyResponse = MsgSubmitProposalResponse();
    return _client.invoke<MsgSubmitProposalResponse>(
        ctx, 'Msg', 'SubmitProposal', request, emptyResponse);
  }

  $async.Future<MsgVoteResponse> vote($pb.ClientContext? ctx, MsgVote request) {
    var emptyResponse = MsgVoteResponse();
    return _client.invoke<MsgVoteResponse>(
        ctx, 'Msg', 'Vote', request, emptyResponse);
  }

  $async.Future<MsgVoteWeightedResponse> voteWeighted(
      $pb.ClientContext? ctx, MsgVoteWeighted request) {
    var emptyResponse = MsgVoteWeightedResponse();
    return _client.invoke<MsgVoteWeightedResponse>(
        ctx, 'Msg', 'VoteWeighted', request, emptyResponse);
  }

  $async.Future<MsgDepositResponse> deposit(
      $pb.ClientContext? ctx, MsgDeposit request) {
    var emptyResponse = MsgDepositResponse();
    return _client.invoke<MsgDepositResponse>(
        ctx, 'Msg', 'Deposit', request, emptyResponse);
  }
}
