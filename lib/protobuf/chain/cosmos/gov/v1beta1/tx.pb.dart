...
class MsgSubmitProposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgSubmitProposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $0.Any.create)
    ..pc<$9.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialDeposit', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
  ...
  factory MsgSubmitProposal({
    $0.Any? content,
    $core.Iterable<$9.Coin>? initialDeposit,
  ...
  @$pb.TagNumber(1)
  set content($0.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $core.List<$9.Coin> get initialDeposit => $_getList(1);
...
class MsgVote extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgVote', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$34.VoteOption>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'option', $pb.PbFieldType.OE, defaultOrMaker: $34.VoteOption.VOTE_OPTION_UNSPECIFIED, valueOf: $34.VoteOption.valueOf, enumValues: $34.VoteOption.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $34.VoteOption get option => $_getN(2);
  @$pb.TagNumber(3)
  set option($34.VoteOption v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class MsgVoteWeighted extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgVoteWeighted', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposalId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'voter')
    ..pc<$34.WeightedVoteOption>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $34.WeightedVoteOption.create)
    ..hasRequiredFields = false
  ;
  ...
  factory MsgVoteWeighted({
    $fixnum.Int64? proposalId,
    $core.String? voter,
    $core.Iterable<$34.WeightedVoteOption>? options,
  }) {
    final _result = create();
    if (proposalId != null) {
      _result.proposalId = proposalId;
  ...
  @$pb.TagNumber(3)
  $core.List<$34.WeightedVoteOption> get options => $_getList(2);
}
...
class MsgDeposit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgDeposit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$9.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$9.Coin> get amount => $_getList(2);
}
...
class MsgApi {
  ...
  $async.Future<MsgSubmitProposalResponse> submitProposal($pb.ClientContext? ctx, MsgSubmitProposal request) {
    var emptyResponse = MsgSubmitProposalResponse();
    return _client.invoke<MsgSubmitProposalResponse>(ctx, 'Msg', 'SubmitProposal', request, emptyResponse);
  }
  $async.Future<MsgVoteResponse> vote($pb.ClientContext? ctx, MsgVote request) {
    var emptyResponse = MsgVoteResponse();
    return _client.invoke<MsgVoteResponse>(ctx, 'Msg', 'Vote', request, emptyResponse);
  }
  $async.Future<MsgVoteWeightedResponse> voteWeighted($pb.ClientContext? ctx, MsgVoteWeighted request) {
    var emptyResponse = MsgVoteWeightedResponse();
    return _client.invoke<MsgVoteWeightedResponse>(ctx, 'Msg', 'VoteWeighted', request, emptyResponse);
  }
  $async.Future<MsgDepositResponse> deposit($pb.ClientContext? ctx, MsgDeposit request) {
    var emptyResponse = MsgDepositResponse();
    return _client.invoke<MsgDepositResponse>(ctx, 'Msg', 'Deposit', request, emptyResponse);
  }
}
