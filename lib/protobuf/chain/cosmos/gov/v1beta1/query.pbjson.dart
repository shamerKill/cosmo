...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  '1': 'Query',
  '2': const [
    const {'1': 'Proposal', '2': '.cosmos.gov.v1beta1.QueryProposalRequest', '3': '.cosmos.gov.v1beta1.QueryProposalResponse', '4': const {}},
    const {'1': 'Proposals', '2': '.cosmos.gov.v1beta1.QueryProposalsRequest', '3': '.cosmos.gov.v1beta1.QueryProposalsResponse', '4': const {}},
    const {'1': 'Vote', '2': '.cosmos.gov.v1beta1.QueryVoteRequest', '3': '.cosmos.gov.v1beta1.QueryVoteResponse', '4': const {}},
    const {'1': 'Votes', '2': '.cosmos.gov.v1beta1.QueryVotesRequest', '3': '.cosmos.gov.v1beta1.QueryVotesResponse', '4': const {}},
    const {'1': 'Params', '2': '.cosmos.gov.v1beta1.QueryParamsRequest', '3': '.cosmos.gov.v1beta1.QueryParamsResponse', '4': const {}},
    const {'1': 'Deposit', '2': '.cosmos.gov.v1beta1.QueryDepositRequest', '3': '.cosmos.gov.v1beta1.QueryDepositResponse', '4': const {}},
    const {'1': 'Deposits', '2': '.cosmos.gov.v1beta1.QueryDepositsRequest', '3': '.cosmos.gov.v1beta1.QueryDepositsResponse', '4': const {}},
    const {'1': 'TallyResult', '2': '.cosmos.gov.v1beta1.QueryTallyResultRequest', '3': '.cosmos.gov.v1beta1.QueryTallyResultResponse', '4': const {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> QueryServiceBase$messageJson = const {
  '.cosmos.gov.v1beta1.QueryProposalRequest': QueryProposalRequest$json,
  '.cosmos.gov.v1beta1.QueryProposalResponse': QueryProposalResponse$json,
  '.cosmos.gov.v1beta1.Proposal': $34.Proposal$json,
  '.google.protobuf.Any': $0.Any$json,
  '.cosmos.gov.v1beta1.TallyResult': $34.TallyResult$json,
  '.google.protobuf.Timestamp': $4.Timestamp$json,
  '.cosmos.base.v1beta1.Coin': $9.Coin$json,
  '.cosmos.gov.v1beta1.QueryProposalsRequest': QueryProposalsRequest$json,
  '.cosmos.base.query.v1beta1.PageRequest': $2.PageRequest$json,
  '.cosmos.gov.v1beta1.QueryProposalsResponse': QueryProposalsResponse$json,
  '.cosmos.base.query.v1beta1.PageResponse': $2.PageResponse$json,
  '.cosmos.gov.v1beta1.QueryVoteRequest': QueryVoteRequest$json,
  '.cosmos.gov.v1beta1.QueryVoteResponse': QueryVoteResponse$json,
  '.cosmos.gov.v1beta1.Vote': $34.Vote$json,
  '.cosmos.gov.v1beta1.WeightedVoteOption': $34.WeightedVoteOption$json,
  '.cosmos.gov.v1beta1.QueryVotesRequest': QueryVotesRequest$json,
  '.cosmos.gov.v1beta1.QueryVotesResponse': QueryVotesResponse$json,
  '.cosmos.gov.v1beta1.QueryParamsRequest': QueryParamsRequest$json,
  '.cosmos.gov.v1beta1.QueryParamsResponse': QueryParamsResponse$json,
  '.cosmos.gov.v1beta1.VotingParams': $34.VotingParams$json,
  '.google.protobuf.Duration': $30.Duration$json,
  '.cosmos.gov.v1beta1.DepositParams': $34.DepositParams$json,
  '.cosmos.gov.v1beta1.TallyParams': $34.TallyParams$json,
  '.cosmos.gov.v1beta1.QueryDepositRequest': QueryDepositRequest$json,
  '.cosmos.gov.v1beta1.QueryDepositResponse': QueryDepositResponse$json,
  '.cosmos.gov.v1beta1.Deposit': $34.Deposit$json,
  '.cosmos.gov.v1beta1.QueryDepositsRequest': QueryDepositsRequest$json,
  '.cosmos.gov.v1beta1.QueryDepositsResponse': QueryDepositsResponse$json,
  '.cosmos.gov.v1beta1.QueryTallyResultRequest': QueryTallyResultRequest$json,
  '.cosmos.gov.v1beta1.QueryTallyResultResponse': QueryTallyResultResponse$json,
};

/// Descriptor for `Query`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List queryServiceDescriptor = $convert.base64Decode('');
