...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  ...
  '2': const [
    const {
      '1': 'Proposal',
      '2': '.cosmos.gov.v1beta1.QueryProposalRequest',
      '3': '.cosmos.gov.v1beta1.QueryProposalResponse',
      '4': const {}
    },
    const {
      '1': 'Proposals',
      '2': '.cosmos.gov.v1beta1.QueryProposalsRequest',
      '3': '.cosmos.gov.v1beta1.QueryProposalsResponse',
      '4': const {}
    },
    const {
      '1': 'Vote',
      '2': '.cosmos.gov.v1beta1.QueryVoteRequest',
      '3': '.cosmos.gov.v1beta1.QueryVoteResponse',
      '4': const {}
    },
    const {
      '1': 'Votes',
      '2': '.cosmos.gov.v1beta1.QueryVotesRequest',
      '3': '.cosmos.gov.v1beta1.QueryVotesResponse',
      '4': const {}
    },
    const {
      '1': 'Params',
      '2': '.cosmos.gov.v1beta1.QueryParamsRequest',
      '3': '.cosmos.gov.v1beta1.QueryParamsResponse',
      '4': const {}
    },
    const {
      '1': 'Deposit',
      '2': '.cosmos.gov.v1beta1.QueryDepositRequest',
      '3': '.cosmos.gov.v1beta1.QueryDepositResponse',
      '4': const {}
    },
    const {
      '1': 'Deposits',
      '2': '.cosmos.gov.v1beta1.QueryDepositsRequest',
      '3': '.cosmos.gov.v1beta1.QueryDepositsResponse',
      '4': const {}
    },
    const {
      '1': 'TallyResult',
      '2': '.cosmos.gov.v1beta1.QueryTallyResultRequest',
      '3': '.cosmos.gov.v1beta1.QueryTallyResultResponse',
      '4': const {}
    },
  ],
};
