...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$34.Deposit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deposits', $pb.PbFieldType.PM, subBuilder: $34.Deposit.create)
    ..pc<$34.Vote>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votes', $pb.PbFieldType.PM, subBuilder: $34.Vote.create)
    ..pc<$34.Proposal>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposals', $pb.PbFieldType.PM, subBuilder: $34.Proposal.create)
    ..aOM<$34.DepositParams>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'depositParams', subBuilder: $34.DepositParams.create)
    ..aOM<$34.VotingParams>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingParams', subBuilder: $34.VotingParams.create)
    ..aOM<$34.TallyParams>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tallyParams', subBuilder: $34.TallyParams.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$34.Deposit> get deposits => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$34.Vote> get votes => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$34.Proposal> get proposals => $_getList(3);

  @$pb.TagNumber(5)
  $34.DepositParams get depositParams => $_getN(4);
  @$pb.TagNumber(5)
  set depositParams($34.DepositParams v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDepositParams() => $_has(4);
  @$pb.TagNumber(5)
  void clearDepositParams() => clearField(5);
  @$pb.TagNumber(5)
  $34.DepositParams ensureDepositParams() => $_ensure(4);

  @$pb.TagNumber(6)
  $34.VotingParams get votingParams => $_getN(5);
  @$pb.TagNumber(6)
  set votingParams($34.VotingParams v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasVotingParams() => $_has(5);
  @$pb.TagNumber(6)
  void clearVotingParams() => clearField(6);
  @$pb.TagNumber(6)
  $34.VotingParams ensureVotingParams() => $_ensure(5);

  @$pb.TagNumber(7)
  $34.TallyParams get tallyParams => $_getN(6);
  @$pb.TagNumber(7)
  set tallyParams($34.TallyParams v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTallyParams() => $_has(6);
  @$pb.TagNumber(7)
  void clearTallyParams() => clearField(7);
  @$pb.TagNumber(7)
  $34.TallyParams ensureTallyParams() => $_ensure(6);
}
