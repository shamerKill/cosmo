...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'SubmitProposal', '2': '.cosmos.gov.v1beta1.MsgSubmitProposal', '3': '.cosmos.gov.v1beta1.MsgSubmitProposalResponse'},
    const {'1': 'Vote', '2': '.cosmos.gov.v1beta1.MsgVote', '3': '.cosmos.gov.v1beta1.MsgVoteResponse'},
    const {'1': 'VoteWeighted', '2': '.cosmos.gov.v1beta1.MsgVoteWeighted', '3': '.cosmos.gov.v1beta1.MsgVoteWeightedResponse'},
    const {'1': 'Deposit', '2': '.cosmos.gov.v1beta1.MsgDeposit', '3': '.cosmos.gov.v1beta1.MsgDepositResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  ...
  '.cosmos.gov.v1beta1.MsgSubmitProposalResponse': MsgSubmitProposalResponse$json,
...
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('');
