...
class QueryProposalsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$34.ProposalStatus>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'proposalStatus',
        $pb.PbFieldType.OE,
        defaultOrMaker: $34.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED,
        valueOf: $34.ProposalStatus.valueOf,
        enumValues: $34.ProposalStatus.values)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set proposalStatus($34.ProposalStatus v) {
    setField(1, v);
  }
...
class QueryParamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$34.VotingParams>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'votingParams',
        subBuilder: $34.VotingParams.create)
    ..aOM<$34.DepositParams>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'depositParams',
        subBuilder: $34.DepositParams.create)
    ..aOM<$34.TallyParams>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'tallyParams',
        subBuilder: $34.TallyParams.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set votingParams($34.VotingParams v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set depositParams($34.DepositParams v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set tallyParams($34.TallyParams v) {
    setField(3, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$34.TallyResult>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'tally',
        subBuilder: $34.TallyResult.create)
    ..hasRequiredFields = false;
...
class QueryApi {
  ...
  $async.Future<QueryProposalResponse> proposal(
      $pb.ClientContext? ctx, QueryProposalRequest request) {
    var emptyResponse = QueryProposalResponse();
    return _client.invoke<QueryProposalResponse>(
        ctx, 'Query', 'Proposal', request, emptyResponse);
  }

  $async.Future<QueryProposalsResponse> proposals(
      $pb.ClientContext? ctx, QueryProposalsRequest request) {
    var emptyResponse = QueryProposalsResponse();
    return _client.invoke<QueryProposalsResponse>(
        ctx, 'Query', 'Proposals', request, emptyResponse);
  }

  $async.Future<QueryVoteResponse> vote(
      $pb.ClientContext? ctx, QueryVoteRequest request) {
    var emptyResponse = QueryVoteResponse();
    return _client.invoke<QueryVoteResponse>(
        ctx, 'Query', 'Vote', request, emptyResponse);
  }

  $async.Future<QueryVotesResponse> votes(
      $pb.ClientContext? ctx, QueryVotesRequest request) {
    var emptyResponse = QueryVotesResponse();
    return _client.invoke<QueryVotesResponse>(
        ctx, 'Query', 'Votes', request, emptyResponse);
  }
  ...
  $async.Future<QueryDepositResponse> deposit(
      $pb.ClientContext? ctx, QueryDepositRequest request) {
    var emptyResponse = QueryDepositResponse();
    return _client.invoke<QueryDepositResponse>(
        ctx, 'Query', 'Deposit', request, emptyResponse);
  }

  $async.Future<QueryDepositsResponse> deposits(
      $pb.ClientContext? ctx, QueryDepositsRequest request) {
    var emptyResponse = QueryDepositsResponse();
    return _client.invoke<QueryDepositsResponse>(
        ctx, 'Query', 'Deposits', request, emptyResponse);
  }

  $async.Future<QueryTallyResultResponse> tallyResult(
      $pb.ClientContext? ctx, QueryTallyResultRequest request) {
    var emptyResponse = QueryTallyResultResponse();
    return _client.invoke<QueryTallyResultResponse>(
        ctx, 'Query', 'TallyResult', request, emptyResponse);
  }
}
