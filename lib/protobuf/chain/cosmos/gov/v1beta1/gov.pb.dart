...
import 'package:alan/proto/google/protobuf/duration.pb.dart' as $30;
...
class Proposal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Proposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposalId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$0.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $0.Any.create)
    ...
    ..pc<$9.Coin>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalDeposit', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
  ...
  factory Proposal({
    ...
    $core.Iterable<$9.Coin>? totalDeposit,
  ...
  @$pb.TagNumber(2)
  set content($0.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(7)
  $core.List<$9.Coin> get totalDeposit => $_getList(6);
...
class DepositParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DepositParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..pc<$9.Coin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minDeposit', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
    ..aOM<$30.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDepositPeriod', subBuilder: $30.Duration.create)
    ..hasRequiredFields = false
  ;

  DepositParams._() : super();
  factory DepositParams({
    $core.Iterable<$9.Coin>? minDeposit,
    $30.Duration? maxDepositPeriod,
  }) {
    final _result = create();
    if (minDeposit != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$9.Coin> get minDeposit => $_getList(0);

  @$pb.TagNumber(2)
  $30.Duration get maxDepositPeriod => $_getN(1);
  @$pb.TagNumber(2)
  set maxDepositPeriod($30.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxDepositPeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxDepositPeriod() => clearField(2);
  @$pb.TagNumber(2)
  $30.Duration ensureMaxDepositPeriod() => $_ensure(1);
}
...
class VotingParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VotingParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.gov.v1beta1'), createEmptyInstance: create)
    ..aOM<$30.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'votingPeriod', subBuilder: $30.Duration.create)
    ..hasRequiredFields = false
  ;

  VotingParams._() : super();
  factory VotingParams({
    $30.Duration? votingPeriod,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $30.Duration get votingPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set votingPeriod($30.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasVotingPeriod() => $_has(0);
  @$pb.TagNumber(1)
  void clearVotingPeriod() => clearField(1);
  @$pb.TagNumber(1)
  $30.Duration ensureVotingPeriod() => $_ensure(0);
}
