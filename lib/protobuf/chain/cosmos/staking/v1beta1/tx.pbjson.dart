...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'CreateValidator', '2': '.cosmos.staking.v1beta1.MsgCreateValidator', '3': '.cosmos.staking.v1beta1.MsgCreateValidatorResponse'},
    const {'1': 'EditValidator', '2': '.cosmos.staking.v1beta1.MsgEditValidator', '3': '.cosmos.staking.v1beta1.MsgEditValidatorResponse'},
    const {'1': 'Delegate', '2': '.cosmos.staking.v1beta1.MsgDelegate', '3': '.cosmos.staking.v1beta1.MsgDelegateResponse'},
    const {'1': 'BeginRedelegate', '2': '.cosmos.staking.v1beta1.MsgBeginRedelegate', '3': '.cosmos.staking.v1beta1.MsgBeginRedelegateResponse'},
    const {'1': 'Undelegate', '2': '.cosmos.staking.v1beta1.MsgUndelegate', '3': '.cosmos.staking.v1beta1.MsgUndelegateResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  '.cosmos.staking.v1beta1.MsgCreateValidator': MsgCreateValidator$json,
  ...
  '.cosmos.staking.v1beta1.MsgCreateValidatorResponse': MsgCreateValidatorResponse$json,
  '.cosmos.staking.v1beta1.MsgEditValidator': MsgEditValidator$json,
  '.cosmos.staking.v1beta1.MsgEditValidatorResponse': MsgEditValidatorResponse$json,
  '.cosmos.staking.v1beta1.MsgDelegate': MsgDelegate$json,
  '.cosmos.staking.v1beta1.MsgDelegateResponse': MsgDelegateResponse$json,
  '.cosmos.staking.v1beta1.MsgBeginRedelegate': MsgBeginRedelegate$json,
  '.cosmos.staking.v1beta1.MsgBeginRedelegateResponse': MsgBeginRedelegateResponse$json,
  '.google.protobuf.Timestamp': $4.Timestamp$json,
  '.cosmos.staking.v1beta1.MsgUndelegate': MsgUndelegate$json,
  '.cosmos.staking.v1beta1.MsgUndelegateResponse': MsgUndelegateResponse$json,
};

/// Descriptor for `Msg`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('');
