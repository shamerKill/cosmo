  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$44.Validator>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'validators',
        $pb.PbFieldType.PM,
        subBuilder: $44.Validator.create)
    ..aOM<$2.PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..pc<$44.DelegationResponse>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'delegationResponses',
        $pb.PbFieldType.PM,
        subBuilder: $44.DelegationResponse.create)
    ..aOM<$2.PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..pc<$44.UnbondingDelegation>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'unbondingResponses',
        $pb.PbFieldType.PM,
        subBuilder: $44.UnbondingDelegation.create)
    ..aOM<$2.PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
...
class QueryDelegationResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set delegationResponse($44.DelegationResponse v) {
    setField(1, v);
  }
...
class QueryUnbondingDelegationResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set unbond($44.UnbondingDelegation v) {
    setField(1, v);
  }
...
class QueryRedelegationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..pc<$44.RedelegationResponse>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'redelegationResponses',
        $pb.PbFieldType.PM,
        subBuilder: $44.RedelegationResponse.create)
    ..aOM<$2.PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  $core.List<$44.RedelegationResponse> get redelegationResponses =>
      $_getList(0);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$44.HistoricalInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'hist',
        subBuilder: $44.HistoricalInfo.create)
    ..hasRequiredFields = false;
...
class QueryApi {
  ...
  $async.Future<QueryValidatorsResponse> validators(
      $pb.ClientContext? ctx, QueryValidatorsRequest request) {
    var emptyResponse = QueryValidatorsResponse();
    return _client.invoke<QueryValidatorsResponse>(
        ctx, 'Query', 'Validators', request, emptyResponse);
  }

  $async.Future<QueryValidatorResponse> validator(
      $pb.ClientContext? ctx, QueryValidatorRequest request) {
    var emptyResponse = QueryValidatorResponse();
    return _client.invoke<QueryValidatorResponse>(
        ctx, 'Query', 'Validator', request, emptyResponse);
  }

  $async.Future<QueryValidatorDelegationsResponse> validatorDelegations(
      $pb.ClientContext? ctx, QueryValidatorDelegationsRequest request) {
    var emptyResponse = QueryValidatorDelegationsResponse();
    return _client.invoke<QueryValidatorDelegationsResponse>(
        ctx, 'Query', 'ValidatorDelegations', request, emptyResponse);
  }

  $async.Future<QueryValidatorUnbondingDelegationsResponse>
      validatorUnbondingDelegations($pb.ClientContext? ctx,
          QueryValidatorUnbondingDelegationsRequest request) {
    var emptyResponse = QueryValidatorUnbondingDelegationsResponse();
    return _client.invoke<QueryValidatorUnbondingDelegationsResponse>(
        ctx, 'Query', 'ValidatorUnbondingDelegations', request, emptyResponse);
  }

  $async.Future<QueryDelegationResponse> delegation(
      $pb.ClientContext? ctx, QueryDelegationRequest request) {
    var emptyResponse = QueryDelegationResponse();
    return _client.invoke<QueryDelegationResponse>(
        ctx, 'Query', 'Delegation', request, emptyResponse);
  }

  $async.Future<QueryUnbondingDelegationResponse> unbondingDelegation(
      $pb.ClientContext? ctx, QueryUnbondingDelegationRequest request) {
    var emptyResponse = QueryUnbondingDelegationResponse();
    return _client.invoke<QueryUnbondingDelegationResponse>(
        ctx, 'Query', 'UnbondingDelegation', request, emptyResponse);
  }

  $async.Future<QueryDelegatorDelegationsResponse> delegatorDelegations(
      $pb.ClientContext? ctx, QueryDelegatorDelegationsRequest request) {
    var emptyResponse = QueryDelegatorDelegationsResponse();
    return _client.invoke<QueryDelegatorDelegationsResponse>(
        ctx, 'Query', 'DelegatorDelegations', request, emptyResponse);
  }

  $async.Future<QueryDelegatorUnbondingDelegationsResponse>
      delegatorUnbondingDelegations($pb.ClientContext? ctx,
          QueryDelegatorUnbondingDelegationsRequest request) {
    var emptyResponse = QueryDelegatorUnbondingDelegationsResponse();
    return _client.invoke<QueryDelegatorUnbondingDelegationsResponse>(
        ctx, 'Query', 'DelegatorUnbondingDelegations', request, emptyResponse);
  }

  $async.Future<QueryRedelegationsResponse> redelegations(
      $pb.ClientContext? ctx, QueryRedelegationsRequest request) {
    var emptyResponse = QueryRedelegationsResponse();
    return _client.invoke<QueryRedelegationsResponse>(
        ctx, 'Query', 'Redelegations', request, emptyResponse);
  }

  $async.Future<QueryDelegatorValidatorsResponse> delegatorValidators(
      $pb.ClientContext? ctx, QueryDelegatorValidatorsRequest request) {
    var emptyResponse = QueryDelegatorValidatorsResponse();
    return _client.invoke<QueryDelegatorValidatorsResponse>(
        ctx, 'Query', 'DelegatorValidators', request, emptyResponse);
  }

  $async.Future<QueryDelegatorValidatorResponse> delegatorValidator(
      $pb.ClientContext? ctx, QueryDelegatorValidatorRequest request) {
    var emptyResponse = QueryDelegatorValidatorResponse();
    return _client.invoke<QueryDelegatorValidatorResponse>(
        ctx, 'Query', 'DelegatorValidator', request, emptyResponse);
  }

  $async.Future<QueryHistoricalInfoResponse> historicalInfo(
      $pb.ClientContext? ctx, QueryHistoricalInfoRequest request) {
    var emptyResponse = QueryHistoricalInfoResponse();
    return _client.invoke<QueryHistoricalInfoResponse>(
        ctx, 'Query', 'HistoricalInfo', request, emptyResponse);
  }

  $async.Future<QueryPoolResponse> pool(
      $pb.ClientContext? ctx, QueryPoolRequest request) {
    var emptyResponse = QueryPoolResponse();
    return _client.invoke<QueryPoolResponse>(
        ctx, 'Query', 'Pool', request, emptyResponse);
  }
