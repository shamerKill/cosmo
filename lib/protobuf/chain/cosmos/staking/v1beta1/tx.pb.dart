...
class MsgCreateValidator extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$44.Description>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'description',
        subBuilder: $44.Description.create)
    ..aOM<$44.CommissionRates>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'commission',
        subBuilder: $44.CommissionRates.create)
    ..aOS(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set description($44.Description v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set commission($44.CommissionRates v) {
    setField(2, v);
  }
...
class MsgApi {
  ...
  $async.Future<MsgCreateValidatorResponse> createValidator(
      $pb.ClientContext? ctx, MsgCreateValidator request) {
    var emptyResponse = MsgCreateValidatorResponse();
    return _client.invoke<MsgCreateValidatorResponse>(
        ctx, 'Msg', 'CreateValidator', request, emptyResponse);
  }

  $async.Future<MsgEditValidatorResponse> editValidator(
      $pb.ClientContext? ctx, MsgEditValidator request) {
    var emptyResponse = MsgEditValidatorResponse();
    return _client.invoke<MsgEditValidatorResponse>(
        ctx, 'Msg', 'EditValidator', request, emptyResponse);
  }

  $async.Future<MsgDelegateResponse> delegate(
      $pb.ClientContext? ctx, MsgDelegate request) {
    var emptyResponse = MsgDelegateResponse();
    return _client.invoke<MsgDelegateResponse>(
        ctx, 'Msg', 'Delegate', request, emptyResponse);
  }

  $async.Future<MsgBeginRedelegateResponse> beginRedelegate(
      $pb.ClientContext? ctx, MsgBeginRedelegate request) {
    var emptyResponse = MsgBeginRedelegateResponse();
    return _client.invoke<MsgBeginRedelegateResponse>(
        ctx, 'Msg', 'BeginRedelegate', request, emptyResponse);
  }

  $async.Future<MsgUndelegateResponse> undelegate(
      $pb.ClientContext? ctx, MsgUndelegate request) {
    var emptyResponse = MsgUndelegateResponse();
    return _client.invoke<MsgUndelegateResponse>(
        ctx, 'Msg', 'Undelegate', request, emptyResponse);
  }
}
