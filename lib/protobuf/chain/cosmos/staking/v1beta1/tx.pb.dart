...
class MsgCreateValidator extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateValidator', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ..aOM<$44.Description>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description', subBuilder: $44.Description.create)
    ..aOM<$44.CommissionRates>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commission', subBuilder: $44.CommissionRates.create)
    ...
    ..aOM<$0.Any>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubkey', subBuilder: $0.Any.create)
    ..aOM<$9.Coin>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $9.Coin.create)
  ...
  @$pb.TagNumber(1)
  $44.Description get description => $_getN(0);
  @$pb.TagNumber(1)
  set description($44.Description v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDescription() => $_has(0);
  @$pb.TagNumber(1)
  void clearDescription() => clearField(1);
  @$pb.TagNumber(1)
  $44.Description ensureDescription() => $_ensure(0);

  @$pb.TagNumber(2)
  $44.CommissionRates get commission => $_getN(1);
  @$pb.TagNumber(2)
  set commission($44.CommissionRates v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCommission() => $_has(1);
  @$pb.TagNumber(2)
  void clearCommission() => clearField(2);
  @$pb.TagNumber(2)
  $44.CommissionRates ensureCommission() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  set pubkey($0.Any v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $9.Coin get value => $_getN(6);
  @$pb.TagNumber(7)
  set value($9.Coin v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasValue() => $_has(6);
  @$pb.TagNumber(7)
  void clearValue() => clearField(7);
  @$pb.TagNumber(7)
  $9.Coin ensureValue() => $_ensure(6);
}
...
class MsgBeginRedelegate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgBeginRedelegate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Coin>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', subBuilder: $9.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $9.Coin get amount => $_getN(3);
  @$pb.TagNumber(4)
  set amount($9.Coin v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAmount() => $_has(3);
  @$pb.TagNumber(4)
  void clearAmount() => clearField(4);
  @$pb.TagNumber(4)
  $9.Coin ensureAmount() => $_ensure(3);
}
...
class MsgApi {
  ...
  $async.Future<MsgCreateValidatorResponse> createValidator($pb.ClientContext? ctx, MsgCreateValidator request) {
    var emptyResponse = MsgCreateValidatorResponse();
    return _client.invoke<MsgCreateValidatorResponse>(ctx, 'Msg', 'CreateValidator', request, emptyResponse);
  }
  $async.Future<MsgEditValidatorResponse> editValidator($pb.ClientContext? ctx, MsgEditValidator request) {
    var emptyResponse = MsgEditValidatorResponse();
    return _client.invoke<MsgEditValidatorResponse>(ctx, 'Msg', 'EditValidator', request, emptyResponse);
  }
  $async.Future<MsgDelegateResponse> delegate($pb.ClientContext? ctx, MsgDelegate request) {
    var emptyResponse = MsgDelegateResponse();
    return _client.invoke<MsgDelegateResponse>(ctx, 'Msg', 'Delegate', request, emptyResponse);
  }
  $async.Future<MsgBeginRedelegateResponse> beginRedelegate($pb.ClientContext? ctx, MsgBeginRedelegate request) {
    var emptyResponse = MsgBeginRedelegateResponse();
    return _client.invoke<MsgBeginRedelegateResponse>(ctx, 'Msg', 'BeginRedelegate', request, emptyResponse);
  }
  $async.Future<MsgUndelegateResponse> undelegate($pb.ClientContext? ctx, MsgUndelegate request) {
    var emptyResponse = MsgUndelegateResponse();
    return _client.invoke<MsgUndelegateResponse>(ctx, 'Msg', 'Undelegate', request, emptyResponse);
  }
}
