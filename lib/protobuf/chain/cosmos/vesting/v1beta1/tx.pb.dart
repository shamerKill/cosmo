...
class MsgApi {
  ...
  $async.Future<MsgCreateVestingAccountResponse> createVestingAccount($pb.ClientContext? ctx, MsgCreateVestingAccount request) {
    var emptyResponse = MsgCreateVestingAccountResponse();
    return _client.invoke<MsgCreateVestingAccountResponse>(ctx, 'Msg', 'CreateVestingAccount', request, emptyResponse);
  }
}
