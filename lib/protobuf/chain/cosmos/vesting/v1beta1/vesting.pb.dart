...
class BaseVestingAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BaseVestingAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$9.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalVesting', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
    ..pc<$9.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegatedFree', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
    ..pc<$9.Coin>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegatedVesting', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
  ...
  factory BaseVestingAccount({
    ...
    $core.Iterable<$9.Coin>? originalVesting,
    $core.Iterable<$9.Coin>? delegatedFree,
    $core.Iterable<$9.Coin>? delegatedVesting,
  ...
  @$pb.TagNumber(2)
  $core.List<$9.Coin> get originalVesting => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$9.Coin> get delegatedFree => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$9.Coin> get delegatedVesting => $_getList(3);
...
class Period extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Period', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$9.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', $pb.PbFieldType.PM, subBuilder: $9.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$9.Coin> get amount => $_getList(1);
}
