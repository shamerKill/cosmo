...
abstract class MsgServiceBase extends $pb.GeneratedService {
  $async.Future<$54.MsgCreateVestingAccountResponse> createVestingAccount(
      $pb.ServerContext ctx, $54.MsgCreateVestingAccount request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'CreateVestingAccount':
        return $54.MsgCreateVestingAccount();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'CreateVestingAccount':
        return this
            .createVestingAccount(ctx, request as $54.MsgCreateVestingAccount);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
