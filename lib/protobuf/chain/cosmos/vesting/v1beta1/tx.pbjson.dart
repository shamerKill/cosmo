...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'CreateVestingAccount', '2': '.cosmos.vesting.v1beta1.MsgCreateVestingAccount', '3': '.cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  '.cosmos.vesting.v1beta1.MsgCreateVestingAccount': MsgCreateVestingAccount$json,
  '.cosmos.base.v1beta1.Coin': $9.Coin$json,
  '.cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse': MsgCreateVestingAccountResponse$json,
};

/// Descriptor for `Msg`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('CgNNc2cSgAEKFENyZWF0ZVZlc3RpbmdBY2NvdW50Ei8uY29zbW9zLnZlc3RpbmcudjFiZXRhMS5Nc2dDcmVhdGVWZXN0aW5nQWNjb3VudBo3LmNvc21vcy52ZXN0aW5nLnYxYmV0YTEuTXNnQ3JlYXRlVmVzdGluZ0FjY291bnRSZXNwb25zZQ==');
