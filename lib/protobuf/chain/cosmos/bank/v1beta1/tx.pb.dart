...
class MsgMultiSend extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgMultiSend', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.bank.v1beta1'), createEmptyInstance: create)
    ..pc<$10.Input>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', $pb.PbFieldType.PM, subBuilder: $10.Input.create)
    ..pc<$10.Output>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', $pb.PbFieldType.PM, subBuilder: $10.Output.create)
    ..hasRequiredFields = false
  ;

  MsgMultiSend._() : super();
  factory MsgMultiSend({
    $core.Iterable<$10.Input>? inputs,
    $core.Iterable<$10.Output>? outputs,
  }) {
    final _result = create();
    if (inputs != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$10.Input> get inputs => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$10.Output> get outputs => $_getList(1);
}
