...
class MsgApi {
  ...
  $async.Future<MsgSendResponse> send($pb.ClientContext? ctx, MsgSend request) {
    ...
    return _client.invoke<MsgSendResponse>(
        ctx, 'Msg', 'Send', request, emptyResponse);
  }

  $async.Future<MsgMultiSendResponse> multiSend(
      $pb.ClientContext? ctx, MsgMultiSend request) {
    var emptyResponse = MsgMultiSendResponse();
    return _client.invoke<MsgMultiSendResponse>(
        ctx, 'Msg', 'MultiSend', request, emptyResponse);
  }
}
