...
class QueryCurrentPlanResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryCurrentPlanResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
    ..aOM<$52.Plan>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plan', subBuilder: $52.Plan.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $52.Plan get plan => $_getN(0);
  @$pb.TagNumber(1)
  set plan($52.Plan v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPlan() => $_has(0);
  @$pb.TagNumber(1)
  void clearPlan() => clearField(1);
  @$pb.TagNumber(1)
  $52.Plan ensurePlan() => $_ensure(0);
}
...
class QueryModuleVersionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryModuleVersionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.upgrade.v1beta1'), createEmptyInstance: create)
    ..pc<$52.ModuleVersion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'moduleVersions', $pb.PbFieldType.PM, subBuilder: $52.ModuleVersion.create)
    ..hasRequiredFields = false
  ;

  QueryModuleVersionsResponse._() : super();
  factory QueryModuleVersionsResponse({
    $core.Iterable<$52.ModuleVersion>? moduleVersions,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<$52.ModuleVersion> get moduleVersions => $_getList(0);
}
...
class QueryApi {
  ...
  $async.Future<QueryCurrentPlanResponse> currentPlan($pb.ClientContext? ctx, QueryCurrentPlanRequest request) {
    var emptyResponse = QueryCurrentPlanResponse();
    return _client.invoke<QueryCurrentPlanResponse>(ctx, 'Query', 'CurrentPlan', request, emptyResponse);
  }
  $async.Future<QueryAppliedPlanResponse> appliedPlan($pb.ClientContext? ctx, QueryAppliedPlanRequest request) {
    var emptyResponse = QueryAppliedPlanResponse();
    return _client.invoke<QueryAppliedPlanResponse>(ctx, 'Query', 'AppliedPlan', request, emptyResponse);
  }
  $async.Future<QueryUpgradedConsensusStateResponse> upgradedConsensusState($pb.ClientContext? ctx, QueryUpgradedConsensusStateRequest request) {
    var emptyResponse = QueryUpgradedConsensusStateResponse();
    return _client.invoke<QueryUpgradedConsensusStateResponse>(ctx, 'Query', 'UpgradedConsensusState', request, emptyResponse);
  }
  $async.Future<QueryModuleVersionsResponse> moduleVersions($pb.ClientContext? ctx, QueryModuleVersionsRequest request) {
    var emptyResponse = QueryModuleVersionsResponse();
    return _client.invoke<QueryModuleVersionsResponse>(ctx, 'Query', 'ModuleVersions', request, emptyResponse);
  }
}
