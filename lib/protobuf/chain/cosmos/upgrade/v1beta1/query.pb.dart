  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$52.ModuleVersion>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'moduleVersions',
        $pb.PbFieldType.PM,
        subBuilder: $52.ModuleVersion.create)
    ..hasRequiredFields = false;
...
class QueryApi {
  ...
  $async.Future<QueryCurrentPlanResponse> currentPlan(
      $pb.ClientContext? ctx, QueryCurrentPlanRequest request) {
    var emptyResponse = QueryCurrentPlanResponse();
    return _client.invoke<QueryCurrentPlanResponse>(
        ctx, 'Query', 'CurrentPlan', request, emptyResponse);
  }

  $async.Future<QueryAppliedPlanResponse> appliedPlan(
      $pb.ClientContext? ctx, QueryAppliedPlanRequest request) {
    var emptyResponse = QueryAppliedPlanResponse();
    return _client.invoke<QueryAppliedPlanResponse>(
        ctx, 'Query', 'AppliedPlan', request, emptyResponse);
  }

  $async.Future<QueryUpgradedConsensusStateResponse> upgradedConsensusState(
      $pb.ClientContext? ctx, QueryUpgradedConsensusStateRequest request) {
    var emptyResponse = QueryUpgradedConsensusStateResponse();
    return _client.invoke<QueryUpgradedConsensusStateResponse>(
        ctx, 'Query', 'UpgradedConsensusState', request, emptyResponse);
  }

  $async.Future<QueryModuleVersionsResponse> moduleVersions(
      $pb.ClientContext? ctx, QueryModuleVersionsRequest request) {
    var emptyResponse = QueryModuleVersionsResponse();
    return _client.invoke<QueryModuleVersionsResponse>(
        ctx, 'Query', 'ModuleVersions', request, emptyResponse);
  }
}
