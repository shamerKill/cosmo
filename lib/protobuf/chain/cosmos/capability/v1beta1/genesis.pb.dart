...
import 'capability.pb.dart' as $23;
...
class GenesisOwners extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisOwners', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.capability.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$23.CapabilityOwners>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexOwners', subBuilder: $23.CapabilityOwners.create)
  ...
  factory GenesisOwners({
    $fixnum.Int64? index,
    $23.CapabilityOwners? indexOwners,
  }) {
  ...
  @$pb.TagNumber(2)
  $23.CapabilityOwners get indexOwners => $_getN(1);
  @$pb.TagNumber(2)
  set indexOwners($23.CapabilityOwners v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndexOwners() => $_has(1);
  @$pb.TagNumber(2)
  void clearIndexOwners() => clearField(2);
  @$pb.TagNumber(2)
  $23.CapabilityOwners ensureIndexOwners() => $_ensure(1);
}
