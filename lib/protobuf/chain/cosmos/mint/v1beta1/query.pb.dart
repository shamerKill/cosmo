...
class QueryParamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.mint.v1beta1'), createEmptyInstance: create)
    ..aOM<$37.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $37.Params.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $37.Params get params => $_getN(0);
  @$pb.TagNumber(1)
  set params($37.Params v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasParams() => $_has(0);
  @$pb.TagNumber(1)
  void clearParams() => clearField(1);
  @$pb.TagNumber(1)
  $37.Params ensureParams() => $_ensure(0);
}
...
class QueryApi {
  ...
  $async.Future<QueryInflationResponse> inflation($pb.ClientContext? ctx, QueryInflationRequest request) {
    var emptyResponse = QueryInflationResponse();
    return _client.invoke<QueryInflationResponse>(ctx, 'Query', 'Inflation', request, emptyResponse);
  }
  $async.Future<QueryAnnualProvisionsResponse> annualProvisions($pb.ClientContext? ctx, QueryAnnualProvisionsRequest request) {
    var emptyResponse = QueryAnnualProvisionsResponse();
    return _client.invoke<QueryAnnualProvisionsResponse>(ctx, 'Query', 'AnnualProvisions', request, emptyResponse);
  }
}
