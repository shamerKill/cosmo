...
class QueryApi {
  ...
  $async.Future<QueryInflationResponse> inflation(
      $pb.ClientContext? ctx, QueryInflationRequest request) {
    var emptyResponse = QueryInflationResponse();
    return _client.invoke<QueryInflationResponse>(
        ctx, 'Query', 'Inflation', request, emptyResponse);
  }

  $async.Future<QueryAnnualProvisionsResponse> annualProvisions(
      $pb.ClientContext? ctx, QueryAnnualProvisionsRequest request) {
    var emptyResponse = QueryAnnualProvisionsResponse();
    return _client.invoke<QueryAnnualProvisionsResponse>(
        ctx, 'Query', 'AnnualProvisions', request, emptyResponse);
  }
}
