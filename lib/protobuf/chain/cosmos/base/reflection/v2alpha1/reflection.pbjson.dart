...
final $typed_data.Uint8List appDescriptorDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List txDescriptorDescriptor = $convert.base64Decode(
    'CgxUeERlc2NyaXB0b3ISGgoIZnVsbG5hbWUYASABKAlSCGZ1bGxuYW1lEkIKBG1zZ3MYAiADKAsyLi5jb3Ntb3MuYmFzZS5yZWZsZWN0aW9uLnYyYWxwaGExLk1zZ0Rlc2NyaXB0b3JSBG1zZ3M=');
...
final $typed_data.Uint8List authnDescriptorDescriptor = $convert.base64Decode(
    'Cg9BdXRobkRlc2NyaXB0b3ISVQoKc2lnbl9tb2RlcxgBIAMoCzI2LmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuU2lnbmluZ01vZGVEZXNjcmlwdG9yUglzaWduTW9kZXM=');
...
final $typed_data.Uint8List signingModeDescriptorDescriptor = $convert.base64Decode(
    'ChVTaWduaW5nTW9kZURlc2NyaXB0b3ISEgoEbmFtZRgBIAEoCVIEbmFtZRIWCgZudW1iZXIYAiABKAVSBm51bWJlchJMCiNhdXRobl9pbmZvX3Byb3ZpZGVyX21ldGhvZF9mdWxsbmFtZRgDIAEoCVIfYXV0aG5JbmZvUHJvdmlkZXJNZXRob2RGdWxsbmFtZQ==');
...
final $typed_data.Uint8List codecDescriptorDescriptor = $convert.base64Decode(
    'Cg9Db2RlY0Rlc2NyaXB0b3ISVAoKaW50ZXJmYWNlcxgBIAMoCzI0LmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuSW50ZXJmYWNlRGVzY3JpcHRvclIKaW50ZXJmYWNlcw==');
...
final $typed_data.Uint8List interfaceDescriptorDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List interfaceImplementerDescriptorDescriptor =
    $convert.base64Decode(
        'Ch5JbnRlcmZhY2VJbXBsZW1lbnRlckRlc2NyaXB0b3ISGgoIZnVsbG5hbWUYASABKAlSCGZ1bGxuYW1lEhkKCHR5cGVfdXJsGAIgASgJUgd0eXBlVXJs');
...
final $typed_data.Uint8List interfaceAcceptingMessageDescriptorDescriptor =
    $convert.base64Decode(
        'CiNJbnRlcmZhY2VBY2NlcHRpbmdNZXNzYWdlRGVzY3JpcHRvchIaCghmdWxsbmFtZRgBIAEoCVIIZnVsbG5hbWUSNAoWZmllbGRfZGVzY3JpcHRvcl9uYW1lcxgCIAMoCVIUZmllbGREZXNjcmlwdG9yTmFtZXM=');
...
final $typed_data.Uint8List configurationDescriptorDescriptor =
    $convert.base64Decode(
        'ChdDb25maWd1cmF0aW9uRGVzY3JpcHRvchJBCh1iZWNoMzJfYWNjb3VudF9hZGRyZXNzX3ByZWZpeBgBIAEoCVIaYmVjaDMyQWNjb3VudEFkZHJlc3NQcmVmaXg=');
...
final $typed_data.Uint8List getAuthnDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChpHZXRBdXRobkRlc2NyaXB0b3JSZXNwb25zZRJGCgVhdXRobhgBIAEoCzIwLmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuQXV0aG5EZXNjcmlwdG9yUgVhdXRobg==');
...
final $typed_data.Uint8List getChainDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChpHZXRDaGFpbkRlc2NyaXB0b3JSZXNwb25zZRJGCgVjaGFpbhgBIAEoCzIwLmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuQ2hhaW5EZXNjcmlwdG9yUgVjaGFpbg==');
...
final $typed_data.Uint8List getCodecDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChpHZXRDb2RlY0Rlc2NyaXB0b3JSZXNwb25zZRJGCgVjb2RlYxgBIAEoCzIwLmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuQ29kZWNEZXNjcmlwdG9yUgVjb2RlYw==');
...
final $typed_data.Uint8List getConfigurationDescriptorResponseDescriptor =
    $convert.base64Decode(
        'CiJHZXRDb25maWd1cmF0aW9uRGVzY3JpcHRvclJlc3BvbnNlElAKBmNvbmZpZxgBIAEoCzI4LmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuQ29uZmlndXJhdGlvbkRlc2NyaXB0b3JSBmNvbmZpZw==');
...
final $typed_data.Uint8List getQueryServicesDescriptorResponseDescriptor =
    $convert.base64Decode(
        'CiJHZXRRdWVyeVNlcnZpY2VzRGVzY3JpcHRvclJlc3BvbnNlElIKB3F1ZXJpZXMYASABKAsyOC5jb3Ntb3MuYmFzZS5yZWZsZWN0aW9uLnYyYWxwaGExLlF1ZXJ5U2VydmljZXNEZXNjcmlwdG9yUgdxdWVyaWVz');
...
final $typed_data.Uint8List getTxDescriptorResponseDescriptor =
    $convert.base64Decode(
        'ChdHZXRUeERlc2NyaXB0b3JSZXNwb25zZRI9CgJ0eBgBIAEoCzItLmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuVHhEZXNjcmlwdG9yUgJ0eA==');
...
final $typed_data.Uint8List queryServicesDescriptorDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeVNlcnZpY2VzRGVzY3JpcHRvchJeCg5xdWVyeV9zZXJ2aWNlcxgBIAMoCzI3LmNvc21vcy5iYXNlLnJlZmxlY3Rpb24udjJhbHBoYTEuUXVlcnlTZXJ2aWNlRGVzY3JpcHRvclINcXVlcnlTZXJ2aWNlcw==');
...
final $typed_data.Uint8List queryServiceDescriptorDescriptor =
    $convert.base64Decode(
        'ChZRdWVyeVNlcnZpY2VEZXNjcmlwdG9yEhoKCGZ1bGxuYW1lGAEgASgJUghmdWxsbmFtZRIbCglpc19tb2R1bGUYAiABKAhSCGlzTW9kdWxlElAKB21ldGhvZHMYAyADKAsyNi5jb3Ntb3MuYmFzZS5yZWZsZWN0aW9uLnYyYWxwaGExLlF1ZXJ5TWV0aG9kRGVzY3JpcHRvclIHbWV0aG9kcw==');
...
final $typed_data.Uint8List queryMethodDescriptorDescriptor = $convert.base64Decode(
    'ChVRdWVyeU1ldGhvZERlc2NyaXB0b3ISEgoEbmFtZRgBIAEoCVIEbmFtZRImCg9mdWxsX3F1ZXJ5X3BhdGgYAiABKAlSDWZ1bGxRdWVyeVBhdGg=');
const $core.Map<$core.String, $core.dynamic> ReflectionServiceBase$json =
    const {
  '1': 'ReflectionService',
  '2': const [
    const {
      '1': 'GetAuthnDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest',
      '3': '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse',
      '4': const {}
    },
    const {
      '1': 'GetChainDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest',
      '3': '.cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse',
      '4': const {}
    },
    const {
      '1': 'GetCodecDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest',
      '3': '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse',
      '4': const {}
    },
    const {
      '1': 'GetConfigurationDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest',
      '3':
          '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse',
      '4': const {}
    },
    const {
      '1': 'GetQueryServicesDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest',
      '3':
    ...
    const {
      '1': 'GetTxDescriptor',
      '2': '.cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest',
      '3': '.cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse',
      '4': const {}
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    ReflectionServiceBase$messageJson = const {
