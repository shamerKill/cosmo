...
class ReflectionServiceApi {
  ...
  $async.Future<GetAuthnDescriptorResponse> getAuthnDescriptor(
      $pb.ClientContext? ctx, GetAuthnDescriptorRequest request) {
    var emptyResponse = GetAuthnDescriptorResponse();
    return _client.invoke<GetAuthnDescriptorResponse>(
        ctx, 'ReflectionService', 'GetAuthnDescriptor', request, emptyResponse);
  }

  $async.Future<GetChainDescriptorResponse> getChainDescriptor(
      $pb.ClientContext? ctx, GetChainDescriptorRequest request) {
    var emptyResponse = GetChainDescriptorResponse();
    return _client.invoke<GetChainDescriptorResponse>(
        ctx, 'ReflectionService', 'GetChainDescriptor', request, emptyResponse);
  }

  $async.Future<GetCodecDescriptorResponse> getCodecDescriptor(
      $pb.ClientContext? ctx, GetCodecDescriptorRequest request) {
    var emptyResponse = GetCodecDescriptorResponse();
    return _client.invoke<GetCodecDescriptorResponse>(
        ctx, 'ReflectionService', 'GetCodecDescriptor', request, emptyResponse);
  }

  $async.Future<GetConfigurationDescriptorResponse> getConfigurationDescriptor(
      $pb.ClientContext? ctx, GetConfigurationDescriptorRequest request) {
    var emptyResponse = GetConfigurationDescriptorResponse();
    return _client.invoke<GetConfigurationDescriptorResponse>(
        ctx,
        'ReflectionService',
  ...
  $async.Future<GetQueryServicesDescriptorResponse> getQueryServicesDescriptor(
      $pb.ClientContext? ctx, GetQueryServicesDescriptorRequest request) {
    var emptyResponse = GetQueryServicesDescriptorResponse();
    return _client.invoke<GetQueryServicesDescriptorResponse>(
        ctx,
        'ReflectionService',
  ...
  $async.Future<GetTxDescriptorResponse> getTxDescriptor(
      $pb.ClientContext? ctx, GetTxDescriptorRequest request) {
    var emptyResponse = GetTxDescriptorResponse();
    return _client.invoke<GetTxDescriptorResponse>(
        ctx, 'ReflectionService', 'GetTxDescriptor', request, emptyResponse);
  }
}
