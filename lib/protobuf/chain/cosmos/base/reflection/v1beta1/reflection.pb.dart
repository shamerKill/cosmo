...
class ReflectionServiceApi {
  ...
  $async.Future<ListAllInterfacesResponse> listAllInterfaces(
      $pb.ClientContext? ctx, ListAllInterfacesRequest request) {
    var emptyResponse = ListAllInterfacesResponse();
    return _client.invoke<ListAllInterfacesResponse>(
        ctx, 'ReflectionService', 'ListAllInterfaces', request, emptyResponse);
  }

  $async.Future<ListImplementationsResponse> listImplementations(
      $pb.ClientContext? ctx, ListImplementationsRequest request) {
    var emptyResponse = ListImplementationsResponse();
    return _client.invoke<ListImplementationsResponse>(ctx, 'ReflectionService',
        'ListImplementations', request, emptyResponse);
  }
}
