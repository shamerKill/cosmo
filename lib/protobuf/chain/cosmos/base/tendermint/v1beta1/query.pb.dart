...
import '../../query/v1beta1/pagination.pb.dart' as $2;
import 'package:alan/proto/google/protobuf/any.pb.dart' as $0;
import 'package:alan/proto/tendermint/types/types.pb.dart' as $15;
import 'package:alan/proto/tendermint/types/block.pb.dart' as $16;
import 'package:alan/proto/tendermint/p2p/types.pb.dart' as $17;
...
class GetBlockByHeightResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBlockByHeightResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.tendermint.v1beta1'), createEmptyInstance: create)
    ..aOM<$15.BlockID>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blockId', subBuilder: $15.BlockID.create)
    ..aOM<$16.Block>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'block', subBuilder: $16.Block.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $15.BlockID get blockId => $_getN(0);
  @$pb.TagNumber(1)
  set blockId($15.BlockID v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBlockId() => $_has(0);
  @$pb.TagNumber(1)
  void clearBlockId() => clearField(1);
  @$pb.TagNumber(1)
  $15.BlockID ensureBlockId() => $_ensure(0);

  @$pb.TagNumber(2)
  $16.Block get block => $_getN(1);
  @$pb.TagNumber(2)
  set block($16.Block v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBlock() => $_has(1);
  @$pb.TagNumber(2)
  void clearBlock() => clearField(2);
  @$pb.TagNumber(2)
  $16.Block ensureBlock() => $_ensure(1);
}
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetNodeInfoResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.tendermint.v1beta1'), createEmptyInstance: create)
    ..aOM<$17.DefaultNodeInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultNodeInfo', subBuilder: $17.DefaultNodeInfo.create)
  ...
  factory GetNodeInfoResponse({
    $17.DefaultNodeInfo? defaultNodeInfo,
  ...
  @$pb.TagNumber(1)
  $17.DefaultNodeInfo get defaultNodeInfo => $_getN(0);
  @$pb.TagNumber(1)
  set defaultNodeInfo($17.DefaultNodeInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDefaultNodeInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearDefaultNodeInfo() => clearField(1);
  @$pb.TagNumber(1)
  $17.DefaultNodeInfo ensureDefaultNodeInfo() => $_ensure(0);
...
class ServiceApi {
  ...
  $async.Future<GetNodeInfoResponse> getNodeInfo($pb.ClientContext? ctx, GetNodeInfoRequest request) {
    ...
    return _client.invoke<GetNodeInfoResponse>(ctx, 'Service', 'GetNodeInfo', request, emptyResponse);
  }
  $async.Future<GetSyncingResponse> getSyncing($pb.ClientContext? ctx, GetSyncingRequest request) {
    var emptyResponse = GetSyncingResponse();
    return _client.invoke<GetSyncingResponse>(ctx, 'Service', 'GetSyncing', request, emptyResponse);
  }
  $async.Future<GetLatestBlockResponse> getLatestBlock($pb.ClientContext? ctx, GetLatestBlockRequest request) {
    var emptyResponse = GetLatestBlockResponse();
    return _client.invoke<GetLatestBlockResponse>(ctx, 'Service', 'GetLatestBlock', request, emptyResponse);
  }
  $async.Future<GetBlockByHeightResponse> getBlockByHeight($pb.ClientContext? ctx, GetBlockByHeightRequest request) {
    var emptyResponse = GetBlockByHeightResponse();
    return _client.invoke<GetBlockByHeightResponse>(ctx, 'Service', 'GetBlockByHeight', request, emptyResponse);
  }
  $async.Future<GetLatestValidatorSetResponse> getLatestValidatorSet($pb.ClientContext? ctx, GetLatestValidatorSetRequest request) {
    var emptyResponse = GetLatestValidatorSetResponse();
    return _client.invoke<GetLatestValidatorSetResponse>(ctx, 'Service', 'GetLatestValidatorSet', request, emptyResponse);
  }
  $async.Future<GetValidatorSetByHeightResponse> getValidatorSetByHeight($pb.ClientContext? ctx, GetValidatorSetByHeightRequest request) {
    var emptyResponse = GetValidatorSetByHeightResponse();
    return _client.invoke<GetValidatorSetByHeightResponse>(ctx, 'Service', 'GetValidatorSetByHeight', request, emptyResponse);
  }
}
