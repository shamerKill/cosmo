  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$15.BlockID>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'blockId',
        subBuilder: $15.BlockID.create)
    ..aOM<$16.Block>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'block',
        subBuilder: $16.Block.create)
    ..hasRequiredFields = false;
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.base.tendermint.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$17.DefaultNodeInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'defaultNodeInfo',
        subBuilder: $17.DefaultNodeInfo.create)
    ..aOM<VersionInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set defaultNodeInfo($17.DefaultNodeInfo v) {
    setField(1, v);
  }
...
class ServiceApi {
  ...
  $async.Future<GetNodeInfoResponse> getNodeInfo(
    ...
    return _client.invoke<GetNodeInfoResponse>(
        ctx, 'Service', 'GetNodeInfo', request, emptyResponse);
  }

  $async.Future<GetSyncingResponse> getSyncing(
      $pb.ClientContext? ctx, GetSyncingRequest request) {
    var emptyResponse = GetSyncingResponse();
    return _client.invoke<GetSyncingResponse>(
        ctx, 'Service', 'GetSyncing', request, emptyResponse);
  }

  $async.Future<GetLatestBlockResponse> getLatestBlock(
      $pb.ClientContext? ctx, GetLatestBlockRequest request) {
    var emptyResponse = GetLatestBlockResponse();
    return _client.invoke<GetLatestBlockResponse>(
        ctx, 'Service', 'GetLatestBlock', request, emptyResponse);
  }

  $async.Future<GetBlockByHeightResponse> getBlockByHeight(
      $pb.ClientContext? ctx, GetBlockByHeightRequest request) {
    var emptyResponse = GetBlockByHeightResponse();
    return _client.invoke<GetBlockByHeightResponse>(
        ctx, 'Service', 'GetBlockByHeight', request, emptyResponse);
  }

  $async.Future<GetLatestValidatorSetResponse> getLatestValidatorSet(
      $pb.ClientContext? ctx, GetLatestValidatorSetRequest request) {
    var emptyResponse = GetLatestValidatorSetResponse();
    return _client.invoke<GetLatestValidatorSetResponse>(
        ctx, 'Service', 'GetLatestValidatorSet', request, emptyResponse);
  }

  $async.Future<GetValidatorSetByHeightResponse> getValidatorSetByHeight(
      $pb.ClientContext? ctx, GetValidatorSetByHeightRequest request) {
    var emptyResponse = GetValidatorSetByHeightResponse();
    return _client.invoke<GetValidatorSetByHeightResponse>(
        ctx, 'Service', 'GetValidatorSetByHeight', request, emptyResponse);
  }
}
