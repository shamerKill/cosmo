...
abstract class MsgServiceBase extends $pb.GeneratedService {
  $async.Future<$24.MsgVerifyInvariantResponse> verifyInvariant(
      $pb.ServerContext ctx, $24.MsgVerifyInvariant request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'VerifyInvariant':
        return $24.MsgVerifyInvariant();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'VerifyInvariant':
        return this.verifyInvariant(ctx, request as $24.MsgVerifyInvariant);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
