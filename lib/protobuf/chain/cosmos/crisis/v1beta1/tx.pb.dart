...
class MsgApi {
  ...
  $async.Future<MsgVerifyInvariantResponse> verifyInvariant($pb.ClientContext? ctx, MsgVerifyInvariant request) {
    var emptyResponse = MsgVerifyInvariantResponse();
    return _client.invoke<MsgVerifyInvariantResponse>(ctx, 'Msg', 'VerifyInvariant', request, emptyResponse);
  }
}
