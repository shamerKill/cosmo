...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'VerifyInvariant', '2': '.cosmos.crisis.v1beta1.MsgVerifyInvariant', '3': '.cosmos.crisis.v1beta1.MsgVerifyInvariantResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  '.cosmos.crisis.v1beta1.MsgVerifyInvariant': MsgVerifyInvariant$json,
  '.cosmos.crisis.v1beta1.MsgVerifyInvariantResponse': MsgVerifyInvariantResponse$json,
};

/// Descriptor for `Msg`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('CgNNc2cSbwoPVmVyaWZ5SW52YXJpYW50EikuY29zbW9zLmNyaXNpcy52MWJldGExLk1zZ1ZlcmlmeUludmFyaWFudBoxLmNvc21vcy5jcmlzaXMudjFiZXRhMS5Nc2dWZXJpZnlJbnZhcmlhbnRSZXNwb25zZQ==');
