...
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {'1': 'Unjail', '2': '.cosmos.slashing.v1beta1.MsgUnjail', '3': '.cosmos.slashing.v1beta1.MsgUnjailResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MsgServiceBase$messageJson = const {
  '.cosmos.slashing.v1beta1.MsgUnjail': MsgUnjail$json,
  '.cosmos.slashing.v1beta1.MsgUnjailResponse': MsgUnjailResponse$json,
};

/// Descriptor for `Msg`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode('CgNNc2cSWAoGVW5qYWlsEiIuY29zbW9zLnNsYXNoaW5nLnYxYmV0YTEuTXNnVW5qYWlsGiouY29zbW9zLnNsYXNoaW5nLnYxYmV0YTEuTXNnVW5qYWlsUmVzcG9uc2U=');
