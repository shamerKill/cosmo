...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  '1': 'Query',
  '2': const [
    const {'1': 'Params', '2': '.cosmos.slashing.v1beta1.QueryParamsRequest', '3': '.cosmos.slashing.v1beta1.QueryParamsResponse', '4': const {}},
    const {'1': 'SigningInfo', '2': '.cosmos.slashing.v1beta1.QuerySigningInfoRequest', '3': '.cosmos.slashing.v1beta1.QuerySigningInfoResponse', '4': const {}},
    const {'1': 'SigningInfos', '2': '.cosmos.slashing.v1beta1.QuerySigningInfosRequest', '3': '.cosmos.slashing.v1beta1.QuerySigningInfosResponse', '4': const {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> QueryServiceBase$messageJson = const {
  ...
  '.cosmos.slashing.v1beta1.QuerySigningInfoRequest': QuerySigningInfoRequest$json,
  '.cosmos.slashing.v1beta1.QuerySigningInfoResponse': QuerySigningInfoResponse$json,
  '.cosmos.slashing.v1beta1.ValidatorSigningInfo': $41.ValidatorSigningInfo$json,
  '.google.protobuf.Timestamp': $4.Timestamp$json,
  '.cosmos.slashing.v1beta1.QuerySigningInfosRequest': QuerySigningInfosRequest$json,
  '.cosmos.base.query.v1beta1.PageRequest': $2.PageRequest$json,
  '.cosmos.slashing.v1beta1.QuerySigningInfosResponse': QuerySigningInfosResponse$json,
...
final $typed_data.Uint8List queryServiceDescriptor = $convert.base64Decode('');
