...
class QueryParamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.slashing.v1beta1'), createEmptyInstance: create)
    ..aOM<$41.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $41.Params.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $41.Params get params => $_getN(0);
  @$pb.TagNumber(1)
  set params($41.Params v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasParams() => $_has(0);
  @$pb.TagNumber(1)
  void clearParams() => clearField(1);
  @$pb.TagNumber(1)
  $41.Params ensureParams() => $_ensure(0);
}
...
class QuerySigningInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QuerySigningInfoResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.slashing.v1beta1'), createEmptyInstance: create)
    ..aOM<$41.ValidatorSigningInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valSigningInfo', subBuilder: $41.ValidatorSigningInfo.create)
    ..hasRequiredFields = false
  ;

  QuerySigningInfoResponse._() : super();
  factory QuerySigningInfoResponse({
    $41.ValidatorSigningInfo? valSigningInfo,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $41.ValidatorSigningInfo get valSigningInfo => $_getN(0);
  @$pb.TagNumber(1)
  set valSigningInfo($41.ValidatorSigningInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasValSigningInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearValSigningInfo() => clearField(1);
  @$pb.TagNumber(1)
  $41.ValidatorSigningInfo ensureValSigningInfo() => $_ensure(0);
}
...
class QuerySigningInfosResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QuerySigningInfosResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.slashing.v1beta1'), createEmptyInstance: create)
    ..pc<$41.ValidatorSigningInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'info', $pb.PbFieldType.PM, subBuilder: $41.ValidatorSigningInfo.create)
  ...
  factory QuerySigningInfosResponse({
    $core.Iterable<$41.ValidatorSigningInfo>? info,
  ...
  @$pb.TagNumber(1)
  $core.List<$41.ValidatorSigningInfo> get info => $_getList(0);
...
class QueryApi {
  ...
  $async.Future<QuerySigningInfoResponse> signingInfo($pb.ClientContext? ctx, QuerySigningInfoRequest request) {
    var emptyResponse = QuerySigningInfoResponse();
    return _client.invoke<QuerySigningInfoResponse>(ctx, 'Query', 'SigningInfo', request, emptyResponse);
  }
  $async.Future<QuerySigningInfosResponse> signingInfos($pb.ClientContext? ctx, QuerySigningInfosRequest request) {
    var emptyResponse = QuerySigningInfosResponse();
    return _client.invoke<QuerySigningInfosResponse>(ctx, 'Query', 'SigningInfos', request, emptyResponse);
  }
}
