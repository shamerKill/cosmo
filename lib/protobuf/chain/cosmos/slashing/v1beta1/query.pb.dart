...
class QuerySigningInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.slashing.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$41.ValidatorSigningInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'valSigningInfo',
        subBuilder: $41.ValidatorSigningInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set valSigningInfo($41.ValidatorSigningInfo v) {
    setField(1, v);
  }
...
class QueryApi {
  ...
  $async.Future<QuerySigningInfoResponse> signingInfo(
      $pb.ClientContext? ctx, QuerySigningInfoRequest request) {
    var emptyResponse = QuerySigningInfoResponse();
    return _client.invoke<QuerySigningInfoResponse>(
        ctx, 'Query', 'SigningInfo', request, emptyResponse);
  }

  $async.Future<QuerySigningInfosResponse> signingInfos(
      $pb.ClientContext? ctx, QuerySigningInfosRequest request) {
    var emptyResponse = QuerySigningInfosResponse();
    return _client.invoke<QuerySigningInfosResponse>(
        ctx, 'Query', 'SigningInfos', request, emptyResponse);
  }
}
