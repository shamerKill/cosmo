...
class SigningInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SigningInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.slashing.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$41.ValidatorSigningInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validatorSigningInfo', subBuilder: $41.ValidatorSigningInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SigningInfo({
    $core.String? address,
    $41.ValidatorSigningInfo? validatorSigningInfo,
  }) {
    final _result = create();
    if (address != null) {
  ...
  @$pb.TagNumber(2)
  $41.ValidatorSigningInfo get validatorSigningInfo => $_getN(1);
  @$pb.TagNumber(2)
  set validatorSigningInfo($41.ValidatorSigningInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValidatorSigningInfo() => $_has(1);
  @$pb.TagNumber(2)
  void clearValidatorSigningInfo() => clearField(2);
  @$pb.TagNumber(2)
  $41.ValidatorSigningInfo ensureValidatorSigningInfo() => $_ensure(1);
}
