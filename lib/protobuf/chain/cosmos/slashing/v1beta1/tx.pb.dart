...
class MsgApi {
  ...
  $async.Future<MsgUnjailResponse> unjail($pb.ClientContext? ctx, MsgUnjail request) {
    var emptyResponse = MsgUnjailResponse();
    return _client.invoke<MsgUnjailResponse>(ctx, 'Msg', 'Unjail', request, emptyResponse);
  }
}
