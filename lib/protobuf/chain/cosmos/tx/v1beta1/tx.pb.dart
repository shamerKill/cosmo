  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$48.SignMode>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mode',
        $pb.PbFieldType.OE,
        defaultOrMaker: $48.SignMode.SIGN_MODE_UNSPECIFIED,
        valueOf: $48.SignMode.valueOf,
        enumValues: $48.SignMode.values)
    ..hasRequiredFields = false;
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$47.CompactBitArray>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bitarray',
        subBuilder: $47.CompactBitArray.create)
    ..pc<ModeInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set bitarray($47.CompactBitArray v) {
    setField(1, v);
  }
