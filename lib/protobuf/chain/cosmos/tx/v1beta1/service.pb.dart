...
import 'tx.pb.dart' as $49;
import '../../base/abci/v1beta1/abci.pb.dart' as $50;
...
class GetTxsEventResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTxsEventResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..pc<$49.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txs', $pb.PbFieldType.PM, subBuilder: $49.Tx.create)
    ..pc<$50.TxResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponses', $pb.PbFieldType.PM, subBuilder: $50.TxResponse.create)
  ...
  factory GetTxsEventResponse({
    $core.Iterable<$49.Tx>? txs,
    $core.Iterable<$50.TxResponse>? txResponses,
  ...
  @$pb.TagNumber(1)
  $core.List<$49.Tx> get txs => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$50.TxResponse> get txResponses => $_getList(1);
...
class BroadcastTxResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BroadcastTxResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$50.TxResponse>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponse', subBuilder: $50.TxResponse.create)
    ..hasRequiredFields = false
  ;

  BroadcastTxResponse._() : super();
  factory BroadcastTxResponse({
    $50.TxResponse? txResponse,
  }) {
    final _result = create();
    if (txResponse != null) {
  ...
  @$pb.TagNumber(1)
  $50.TxResponse get txResponse => $_getN(0);
  @$pb.TagNumber(1)
  set txResponse($50.TxResponse v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTxResponse() => $_has(0);
  @$pb.TagNumber(1)
  void clearTxResponse() => clearField(1);
  @$pb.TagNumber(1)
  $50.TxResponse ensureTxResponse() => $_ensure(0);
}
...
class SimulateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$49.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tx', subBuilder: $49.Tx.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $49.Tx get tx => $_getN(0);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set tx($49.Tx v) { setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
...
class SimulateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$50.GasInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gasInfo', subBuilder: $50.GasInfo.create)
    ..aOM<$50.Result>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: $50.Result.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $50.GasInfo get gasInfo => $_getN(0);
  @$pb.TagNumber(1)
  set gasInfo($50.GasInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGasInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearGasInfo() => clearField(1);
  @$pb.TagNumber(1)
  $50.GasInfo ensureGasInfo() => $_ensure(0);

  @$pb.TagNumber(2)
  $50.Result get result => $_getN(1);
  @$pb.TagNumber(2)
  set result($50.Result v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasResult() => $_has(1);
  @$pb.TagNumber(2)
  void clearResult() => clearField(2);
  @$pb.TagNumber(2)
  $50.Result ensureResult() => $_ensure(1);
}
...
class GetTxResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTxResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.tx.v1beta1'), createEmptyInstance: create)
    ..aOM<$49.Tx>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tx', subBuilder: $49.Tx.create)
    ..aOM<$50.TxResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'txResponse', subBuilder: $50.TxResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $50.TxResponse get txResponse => $_getN(1);
  @$pb.TagNumber(2)
  set txResponse($50.TxResponse v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTxResponse() => $_has(1);
  @$pb.TagNumber(2)
  void clearTxResponse() => clearField(2);
  @$pb.TagNumber(2)
  $50.TxResponse ensureTxResponse() => $_ensure(1);
}
