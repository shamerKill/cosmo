  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$50.TxResponse>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'txResponses',
        $pb.PbFieldType.PM,
        subBuilder: $50.TxResponse.create)
    ..aOM<$2.PageResponse>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
...
class BroadcastTxResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set txResponse($50.TxResponse v) {
    setField(1, v);
  }
...
class SimulateRequest extends $pb.GeneratedMessage {
  ...
  factory SimulateRequest({
    @$core.Deprecated('This field is deprecated.') $49.Tx? tx,
    $core.List<$core.int>? txBytes,
  }) {
    final _result = create();
    if (tx != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$50.GasInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'gasInfo',
        subBuilder: $50.GasInfo.create)
    ..aOM<$50.Result>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'result',
        subBuilder: $50.Result.create)
    ..hasRequiredFields = false;
