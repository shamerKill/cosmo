...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  ...
  '2': const [
    const {
      '1': 'Evidence',
      '2': '.cosmos.evidence.v1beta1.QueryEvidenceRequest',
      '3': '.cosmos.evidence.v1beta1.QueryEvidenceResponse',
      '4': const {}
    },
    const {
      '1': 'AllEvidence',
      '2': '.cosmos.evidence.v1beta1.QueryAllEvidenceRequest',
      '3': '.cosmos.evidence.v1beta1.QueryAllEvidenceResponse',
      '4': const {}
    },
  ],
};
...
final $typed_data.Uint8List queryServiceDescriptor = $convert.base64Decode(
    '');
