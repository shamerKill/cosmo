...
class Params extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set baseFeeChangeDenominator($core.int v) {
  ...
  @$pb.TagNumber(3)
  set elasticityMultiplier($core.int v) {
  ...
  @$pb.TagNumber(4)
  set initialBaseFee($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set enableHeight($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
