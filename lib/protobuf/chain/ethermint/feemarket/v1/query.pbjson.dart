...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.ethermint.feemarket.v1.Params',
      '8': const {},
      '10': 'params'
    },
  ],
...
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode(
    'ChNRdWVyeVBhcmFtc1Jlc3BvbnNlEjwKBnBhcmFtcxgBIAEoCzIeLmV0aGVybWludC5mZWVtYXJrZXQudjEuUGFyYW1zQgTI3h8AUgZwYXJhbXM=');
...
final $typed_data.Uint8List queryBaseFeeRequestDescriptor =
    $convert.base64Decode('ChNRdWVyeUJhc2VGZWVSZXF1ZXN0');
...
final $typed_data.Uint8List queryBaseFeeResponseDescriptor = $convert.base64Decode(
    'ChRRdWVyeUJhc2VGZWVSZXNwb25zZRJFCghiYXNlX2ZlZRgBIAEoCUIq2t4fJmdpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuSW50UgdiYXNlRmVl');
...
final $typed_data.Uint8List queryBlockGasRequestDescriptor =
    $convert.base64Decode('ChRRdWVyeUJsb2NrR2FzUmVxdWVzdA==');
...
final $typed_data.Uint8List queryBlockGasResponseDescriptor = $convert
    .base64Decode('ChVRdWVyeUJsb2NrR2FzUmVzcG9uc2USEAoDZ2FzGAEgASgDUgNnYXM=');
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  '1': 'Query',
  '2': const [
    const {
      '1': 'Params',
      '2': '.ethermint.feemarket.v1.QueryParamsRequest',
      '3': '.ethermint.feemarket.v1.QueryParamsResponse',
      '4': const {}
    },
    const {
      '1': 'BaseFee',
      '2': '.ethermint.feemarket.v1.QueryBaseFeeRequest',
      '3': '.ethermint.feemarket.v1.QueryBaseFeeResponse',
      '4': const {}
    },
    const {
      '1': 'BlockGas',
      '2': '.ethermint.feemarket.v1.QueryBlockGasRequest',
      '3': '.ethermint.feemarket.v1.QueryBlockGasResponse',
      '4': const {}
    },
  ],
};
...
final $typed_data.Uint8List queryServiceDescriptor = $convert.base64Decode(
    '');
