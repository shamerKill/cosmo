...
class QueryParamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ethermint.feemarket.v1'), createEmptyInstance: create)
    ..aOM<$58.Params>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $58.Params.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set params($58.Params v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class QueryApi {
  ...
  $async.Future<QueryBaseFeeResponse> baseFee($pb.ClientContext? ctx, QueryBaseFeeRequest request) {
    var emptyResponse = QueryBaseFeeResponse();
    return _client.invoke<QueryBaseFeeResponse>(ctx, 'Query', 'BaseFee', request, emptyResponse);
  }
  $async.Future<QueryBlockGasResponse> blockGas($pb.ClientContext? ctx, QueryBlockGasRequest request) {
    var emptyResponse = QueryBlockGasResponse();
    return _client.invoke<QueryBlockGasResponse>(ctx, 'Query', 'BlockGas', request, emptyResponse);
  }
}
