...
class QueryBaseFeeRequest extends $pb.GeneratedMessage {
  ...
  factory QueryBaseFeeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryBaseFeeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryBaseFeeRequest copyWith(void Function(QueryBaseFeeRequest) updates) =>
      super.copyWith((message) => updates(message as QueryBaseFeeRequest))
          as QueryBaseFeeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryBaseFeeRequest create() => QueryBaseFeeRequest._();
  QueryBaseFeeRequest createEmptyInstance() => create();
  static $pb.PbList<QueryBaseFeeRequest> createRepeated() =>
      $pb.PbList<QueryBaseFeeRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryBaseFeeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryBaseFeeRequest>(create);
...
class QueryBaseFeeResponse extends $pb.GeneratedMessage {
  ...
  factory QueryBaseFeeResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryBaseFeeResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QueryBaseFeeResponse clone() =>
      QueryBaseFeeResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryBaseFeeResponse copyWith(void Function(QueryBaseFeeResponse) updates) =>
      super.copyWith((message) => updates(message as QueryBaseFeeResponse))
          as QueryBaseFeeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryBaseFeeResponse create() => QueryBaseFeeResponse._();
  QueryBaseFeeResponse createEmptyInstance() => create();
  static $pb.PbList<QueryBaseFeeResponse> createRepeated() =>
      $pb.PbList<QueryBaseFeeResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryBaseFeeResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryBaseFeeResponse>(create);
...
class QueryBlockGasRequest extends $pb.GeneratedMessage {
  ...
  factory QueryBlockGasRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryBlockGasRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QueryBlockGasRequest clone() =>
      QueryBlockGasRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryBlockGasRequest copyWith(void Function(QueryBlockGasRequest) updates) =>
      super.copyWith((message) => updates(message as QueryBlockGasRequest))
          as QueryBlockGasRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryBlockGasRequest create() => QueryBlockGasRequest._();
  QueryBlockGasRequest createEmptyInstance() => create();
  static $pb.PbList<QueryBlockGasRequest> createRepeated() =>
      $pb.PbList<QueryBlockGasRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryBlockGasRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryBlockGasRequest>(create);
...
class QueryBlockGasResponse extends $pb.GeneratedMessage {
  ...
  factory QueryBlockGasResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryBlockGasResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QueryBlockGasResponse clone() =>
      QueryBlockGasResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryBlockGasResponse copyWith(
          void Function(QueryBlockGasResponse) updates) =>
      super.copyWith((message) => updates(message as QueryBlockGasResponse))
          as QueryBlockGasResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryBlockGasResponse create() => QueryBlockGasResponse._();
  QueryBlockGasResponse createEmptyInstance() => create();
  static $pb.PbList<QueryBlockGasResponse> createRepeated() =>
      $pb.PbList<QueryBlockGasResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryBlockGasResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryBlockGasResponse>(create);
...
class QueryApi {
  ...
  $async.Future<QueryBaseFeeResponse> baseFee(
      $pb.ClientContext? ctx, QueryBaseFeeRequest request) {
    var emptyResponse = QueryBaseFeeResponse();
    return _client.invoke<QueryBaseFeeResponse>(
        ctx, 'Query', 'BaseFee', request, emptyResponse);
  }

  $async.Future<QueryBlockGasResponse> blockGas(
      $pb.ClientContext? ctx, QueryBlockGasRequest request) {
    var emptyResponse = QueryBlockGasResponse();
    return _client.invoke<QueryBlockGasResponse>(
        ctx, 'Query', 'BlockGas', request, emptyResponse);
  }
}
