...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  '1': 'Query',
  '2': const [
    const {'1': 'Account', '2': '.ethermint.evm.v1.QueryAccountRequest', '3': '.ethermint.evm.v1.QueryAccountResponse', '4': const {}},
    const {'1': 'CosmosAccount', '2': '.ethermint.evm.v1.QueryCosmosAccountRequest', '3': '.ethermint.evm.v1.QueryCosmosAccountResponse', '4': const {}},
    const {'1': 'ValidatorAccount', '2': '.ethermint.evm.v1.QueryValidatorAccountRequest', '3': '.ethermint.evm.v1.QueryValidatorAccountResponse', '4': const {}},
    const {'1': 'Balance', '2': '.ethermint.evm.v1.QueryBalanceRequest', '3': '.ethermint.evm.v1.QueryBalanceResponse', '4': const {}},
    const {'1': 'Storage', '2': '.ethermint.evm.v1.QueryStorageRequest', '3': '.ethermint.evm.v1.QueryStorageResponse', '4': const {}},
    const {'1': 'Code', '2': '.ethermint.evm.v1.QueryCodeRequest', '3': '.ethermint.evm.v1.QueryCodeResponse', '4': const {}},
    const {'1': 'Params', '2': '.ethermint.evm.v1.QueryParamsRequest', '3': '.ethermint.evm.v1.QueryParamsResponse', '4': const {}},
    const {'1': 'EthCall', '2': '.ethermint.evm.v1.EthCallRequest', '3': '.ethermint.evm.v1.MsgEthereumTxResponse', '4': const {}},
    const {'1': 'EstimateGas', '2': '.ethermint.evm.v1.EthCallRequest', '3': '.ethermint.evm.v1.EstimateGasResponse', '4': const {}},
    const {'1': 'TraceTx', '2': '.ethermint.evm.v1.QueryTraceTxRequest', '3': '.ethermint.evm.v1.QueryTraceTxResponse', '4': const {}},
    const {'1': 'TraceBlock', '2': '.ethermint.evm.v1.QueryTraceBlockRequest', '3': '.ethermint.evm.v1.QueryTraceBlockResponse', '4': const {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> QueryServiceBase$messageJson = const {
  ...
  '.ethermint.evm.v1.QueryCosmosAccountResponse': QueryCosmosAccountResponse$json,
  '.ethermint.evm.v1.QueryValidatorAccountRequest': QueryValidatorAccountRequest$json,
  '.ethermint.evm.v1.QueryValidatorAccountResponse': QueryValidatorAccountResponse$json,
