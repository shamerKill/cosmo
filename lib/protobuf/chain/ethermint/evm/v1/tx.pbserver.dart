...
abstract class MsgServiceBase extends $pb.GeneratedService {
  $async.Future<$56.MsgEthereumTxResponse> ethereumTx(
      $pb.ServerContext ctx, $56.MsgEthereumTx request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'EthereumTx':
        return $56.MsgEthereumTx();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (method) {
      case 'EthereumTx':
        return this.ethereumTx(ctx, request as $56.MsgEthereumTx);
      default:
        throw $core.ArgumentError('Unknown method: $method');
    }
  }
