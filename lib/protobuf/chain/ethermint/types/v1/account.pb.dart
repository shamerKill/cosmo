...
import '../../../cosmos/auth/v1beta1/auth.pb.dart' as $1;
...
class EthAccount extends $pb.GeneratedMessage {
  ...
  factory EthAccount.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EthAccount.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  EthAccount copyWith(void Function(EthAccount) updates) =>
      super.copyWith((message) => updates(message as EthAccount))
          as EthAccount; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static EthAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EthAccount>(create);
