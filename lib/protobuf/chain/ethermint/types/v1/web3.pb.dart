...
class ExtensionOptionsWeb3Tx extends $pb.GeneratedMessage {
  ...
  factory ExtensionOptionsWeb3Tx.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ExtensionOptionsWeb3Tx.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ExtensionOptionsWeb3Tx clone() =>
      ExtensionOptionsWeb3Tx()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ExtensionOptionsWeb3Tx copyWith(
          void Function(ExtensionOptionsWeb3Tx) updates) =>
      super.copyWith((message) => updates(message as ExtensionOptionsWeb3Tx))
          as ExtensionOptionsWeb3Tx; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExtensionOptionsWeb3Tx create() => ExtensionOptionsWeb3Tx._();
  ExtensionOptionsWeb3Tx createEmptyInstance() => create();
  static $pb.PbList<ExtensionOptionsWeb3Tx> createRepeated() =>
      $pb.PbList<ExtensionOptionsWeb3Tx>();
  @$core.pragma('dart2js:noInline')
  static ExtensionOptionsWeb3Tx getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExtensionOptionsWeb3Tx>(create);
  static ExtensionOptionsWeb3Tx? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get typedDataChainId => $_getI64(0);
  @$pb.TagNumber(1)
  set typedDataChainId($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(3)
  set feePayerSig($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
