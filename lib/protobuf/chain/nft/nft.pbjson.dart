...
final $typed_data.Uint8List nFTDescriptor = $convert.base64Decode(
    'CgNORlQSFgoCaWQYASABKAlCBuLeHwJJRFICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIZCgN1cmkYAyABKAlCB+LeHwNVUklSA3VyaRISCgRkYXRhGAQgASgJUgRkYXRhEhQKBW93bmVyGAUgASgJUgVvd25lcg==');
...
final $typed_data.Uint8List classDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List collectionDescriptor = $convert.base64Decode(
    'CgpDb2xsZWN0aW9uEjAKBWNsYXNzGAEgASgLMhQucGx1Z2NoYWluLm5mdC5DbGFzc0IEyN4fAFIFY2xhc3MSNAoEbmZ0cxgCIAMoCzISLnBsdWdjaGFpbi5uZnQuTkZUQgzi3h8ETkZUc8jeHwBSBG5mdHM=');
...
final $typed_data.Uint8List collectionIDDescriptor = $convert.base64Decode(
    'CgxDb2xsZWN0aW9uSUQSJgoIQ2xhc3NfaWQYASABKAlCC+LeHwdDbGFzc0lEUgdDbGFzc0lkEiMKB25mdF9pZHMYAiADKAlCCuLeHwZORlRJRHNSBm5mdElkcw==');
...
final $typed_data.Uint8List ownerDescriptor = $convert.base64Decode(
    'CgVPd25lchIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEmgKDmNvbGxlY3Rpb25faWRzGAIgAygLMhsucGx1Z2NoYWluLm5mdC5Db2xsZWN0aW9uSURCJPLeHwt5YW1sOiJjaWRzIuLeHw1Db2xsZWN0aW9uSURzyN4fAFINY29sbGVjdGlvbklkcw==');
