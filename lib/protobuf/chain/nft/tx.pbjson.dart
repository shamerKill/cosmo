...
final $typed_data.Uint8List msgIssueClassDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List msgIssueClassResponseDescriptor =
    $convert.base64Decode('ChVNc2dJc3N1ZUNsYXNzUmVzcG9uc2U=');
...
final $typed_data.Uint8List msgIssueNFTDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List msgIssueNFTResponseDescriptor =
    $convert.base64Decode('ChNNc2dJc3N1ZU5GVFJlc3BvbnNl');
...
final $typed_data.Uint8List msgEditNFTDescriptor = $convert.base64Decode(
    'CgpNc2dFZGl0TkZUEhYKAmlkGAEgASgJQgbi3h8CSURSAmlkEiYKCGNsYXNzX2lkGAIgASgJQgvi3h8HQ2xhc3NJRFIHY2xhc3NJZBISCgRuYW1lGAMgASgJUgRuYW1lEhkKA3VyaRgEIAEoCUIH4t4fA1VSSVIDdXJpEhIKBGRhdGEYBSABKAlSBGRhdGESFAoFb3duZXIYBiABKAlSBW93bmVyOgTooB8B');
...
final $typed_data.Uint8List msgEditNFTResponseDescriptor =
    $convert.base64Decode('ChJNc2dFZGl0TkZUUmVzcG9uc2U=');
...
final $typed_data.Uint8List msgBurnNFTDescriptor = $convert.base64Decode(
    'CgpNc2dCdXJuTkZUEhYKAmlkGAEgASgJQgbi3h8CSURSAmlkEiYKCGNsYXNzX2lkGAIgASgJQgvi3h8HQ2xhc3NJRFIHY2xhc3NJZBIUCgVvd25lchgDIAEoCVIFb3duZXI6BOigHwE=');
...
final $typed_data.Uint8List msgBurnNFTResponseDescriptor =
    $convert.base64Decode('ChJNc2dCdXJuTkZUUmVzcG9uc2U=');
...
final $typed_data.Uint8List msgTransferNFTDescriptor = $convert.base64Decode(
    'Cg5Nc2dUcmFuc2Zlck5GVBIWCgJpZBgBIAEoCUIG4t4fAklEUgJpZBImCghjbGFzc19pZBgCIAEoCUIL4t4fB0NsYXNzSURSB2NsYXNzSWQSHAoJcmVjaXBpZW50GAMgASgJUglyZWNpcGllbnQSFAoFb3duZXIYBCABKAlSBW93bmVyOgTooB8B');
...
final $typed_data.Uint8List msgTransferNFTResponseDescriptor =
    $convert.base64Decode('ChZNc2dUcmFuc2Zlck5GVFJlc3BvbnNl');
...
final $typed_data.Uint8List msgTransferClassDescriptor = $convert.base64Decode(
    'ChBNc2dUcmFuc2ZlckNsYXNzEhYKAmlkGAEgASgJQgbi3h8CSURSAmlkEhQKBW93bmVyGAIgASgJUgVvd25lchIcCglyZWNpcGllbnQYAyABKAlSCXJlY2lwaWVudDoE6KAfAQ==');
...
final $typed_data.Uint8List msgTransferClassResponseDescriptor =
    $convert.base64Decode('ChhNc2dUcmFuc2ZlckNsYXNzUmVzcG9uc2U=');
const $core.Map<$core.String, $core.dynamic> MsgServiceBase$json = const {
  '1': 'Msg',
  '2': const [
    const {
      '1': 'IssueClass',
      '2': '.plugchain.nft.MsgIssueClass',
      '3': '.plugchain.nft.MsgIssueClassResponse'
    },
    const {
      '1': 'IssueNFT',
      '2': '.plugchain.nft.MsgIssueNFT',
      '3': '.plugchain.nft.MsgIssueNFTResponse'
    },
    const {
      '1': 'EditNFT',
      '2': '.plugchain.nft.MsgEditNFT',
      '3': '.plugchain.nft.MsgEditNFTResponse'
    },
    const {
      '1': 'BurnNFT',
      '2': '.plugchain.nft.MsgBurnNFT',
      '3': '.plugchain.nft.MsgBurnNFTResponse'
    },
    const {
      '1': 'TransferNFT',
      '2': '.plugchain.nft.MsgTransferNFT',
      '3': '.plugchain.nft.MsgTransferNFTResponse'
    },
    const {
      '1': 'TransferClass',
      '2': '.plugchain.nft.MsgTransferClass',
      '3': '.plugchain.nft.MsgTransferClassResponse'
    },
  ],
};
...
final $typed_data.Uint8List msgServiceDescriptor = $convert.base64Decode(
    '');
