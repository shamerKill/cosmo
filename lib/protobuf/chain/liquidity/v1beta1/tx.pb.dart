...
class MsgCreatePool extends $pb.GeneratedMessage {
  ...
  factory MsgCreatePool({
    ...
    $core.int? poolTypeId,
    $core.Iterable<$2.Coin>? depositCoins,
  }) {
  ...
  @$pb.TagNumber(4)
  $core.List<$2.Coin> get depositCoins => $_getList(2);
}
...
class MsgWithdrawWithinBatch extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $2.Coin ensurePoolCoin() => $_ensure(2);
}
...
class MsgSwapWithinBatch extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $2.Coin ensureOfferCoin() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $2.Coin ensureOfferCoinFee() => $_ensure(5);
