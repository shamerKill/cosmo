...
class Params extends $pb.GeneratedMessage {
  ...
  factory Params({
    ...
    $core.Iterable<$2.Coin>? poolCreationFee,
  ...
  @$pb.TagNumber(5)
  $core.List<$2.Coin> get poolCreationFee => $_getList(4);
...
class PoolMetadata extends $pb.GeneratedMessage {
  ...
  factory PoolMetadata({
    $fixnum.Int64? poolId,
    $2.Coin? poolCoinTotalSupply,
    $core.Iterable<$2.Coin>? reserveCoins,
  }) {
    final _result = create();
    if (poolId != null) {
  ...
  @$pb.TagNumber(2)
  $2.Coin ensurePoolCoinTotalSupply() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.List<$2.Coin> get reserveCoins => $_getList(2);
}
...
class SwapMsgState extends $pb.GeneratedMessage {
  ...
  factory SwapMsgState({
    ...
    $2.Coin? exchangedOfferCoin,
    $2.Coin? remainingOfferCoin,
    $2.Coin? reservedOfferCoinFee,
  ...
  @$pb.TagNumber(7)
  $2.Coin ensureExchangedOfferCoin() => $_ensure(6);
  ...
  @$pb.TagNumber(8)
  $2.Coin ensureRemainingOfferCoin() => $_ensure(7);
  ...
  @$pb.TagNumber(9)
  $2.Coin ensureReservedOfferCoinFee() => $_ensure(8);
