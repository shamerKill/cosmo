...
final $typed_data.Uint8List queryLiquidityPoolRequestDescriptor =
    $convert.base64Decode(
        'ChlRdWVyeUxpcXVpZGl0eVBvb2xSZXF1ZXN0EhcKB3Bvb2xfaWQYASABKARSBnBvb2xJZA==');
...
const QueryLiquidityPoolResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.Pool',
      '8': const {},
      '10': 'pool'
    },
  ],
...
final $typed_data.Uint8List queryLiquidityPoolResponseDescriptor =
    $convert.base64Decode(
        'ChpRdWVyeUxpcXVpZGl0eVBvb2xSZXNwb25zZRI8CgRwb29sGAEgASgLMiIudGVuZGVybWludC5saXF1aWRpdHkudjFiZXRhMS5Qb29sQgTI3h8AUgRwb29s');
@$core.Deprecated(
    'Use queryLiquidityPoolByPoolCoinDenomRequestDescriptor instead')
...
final $typed_data.Uint8List queryLiquidityPoolByPoolCoinDenomRequestDescriptor =
    $convert.base64Decode(
        'CihRdWVyeUxpcXVpZGl0eVBvb2xCeVBvb2xDb2luRGVub21SZXF1ZXN0EiYKD3Bvb2xfY29pbl9kZW5vbRgBIAEoCVINcG9vbENvaW5EZW5vbQ==');
...
final $typed_data.Uint8List queryLiquidityPoolByReserveAccRequestDescriptor =
    $convert.base64Decode(
        'CiVRdWVyeUxpcXVpZGl0eVBvb2xCeVJlc2VydmVBY2NSZXF1ZXN0Eh8KC3Jlc2VydmVfYWNjGAEgASgJUgpyZXNlcnZlQWNj');
...
final $typed_data.Uint8List queryLiquidityPoolBatchRequestDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeUxpcXVpZGl0eVBvb2xCYXRjaFJlcXVlc3QSFwoHcG9vbF9pZBgBIAEoBFIGcG9vbElk');
...
const QueryLiquidityPoolBatchResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.PoolBatch',
      '8': const {},
      '10': 'batch'
    },
  ],
...
final $typed_data.Uint8List queryLiquidityPoolBatchResponseDescriptor =
    $convert.base64Decode(
        'Ch9RdWVyeUxpcXVpZGl0eVBvb2xCYXRjaFJlc3BvbnNlEkMKBWJhdGNoGAEgASgLMicudGVuZGVybWludC5saXF1aWRpdHkudjFiZXRhMS5Qb29sQmF0Y2hCBMjeHwBSBWJhdGNo');
...
final $typed_data.Uint8List queryLiquidityPoolsRequestDescriptor =
    $convert.base64Decode(
        'ChpRdWVyeUxpcXVpZGl0eVBvb2xzUmVxdWVzdBJGCgpwYWdpbmF0aW9uGAEgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
final $typed_data.Uint8List queryLiquidityPoolsResponseDescriptor =
    $convert.base64Decode(
        'ChtRdWVyeUxpcXVpZGl0eVBvb2xzUmVzcG9uc2USPgoFcG9vbHMYASADKAsyIi50ZW5kZXJtaW50LmxpcXVpZGl0eS52MWJldGExLlBvb2xCBMjeHwBSBXBvb2xzEkcKCnBhZ2luYXRpb24YAiABKAsyJy5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.Params',
      '8': const {},
      '10': 'params'
    },
  ],
...
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode(
    'ChNRdWVyeVBhcmFtc1Jlc3BvbnNlEkIKBnBhcmFtcxgBIAEoCzIkLnRlbmRlcm1pbnQubGlxdWlkaXR5LnYxYmV0YTEuUGFyYW1zQgTI3h8AUgZwYXJhbXM=');
...
final $typed_data.Uint8List queryPoolBatchSwapMsgsRequestDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeVBvb2xCYXRjaFN3YXBNc2dzUmVxdWVzdBIXCgdwb29sX2lkGAEgASgEUgZwb29sSWQSRgoKcGFnaW5hdGlvbhgCIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryPoolBatchSwapMsgRequestDescriptor =
    $convert.base64Decode(
        'ChxRdWVyeVBvb2xCYXRjaFN3YXBNc2dSZXF1ZXN0EhcKB3Bvb2xfaWQYASABKARSBnBvb2xJZBIbCgltc2dfaW5kZXgYAiABKARSCG1zZ0luZGV4');
...
const QueryPoolBatchSwapMsgsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.SwapMsgState',
      '8': const {},
      '10': 'swaps'
    },
    const {
...
final $typed_data.Uint8List queryPoolBatchSwapMsgsResponseDescriptor =
    $convert.base64Decode(
        'Ch5RdWVyeVBvb2xCYXRjaFN3YXBNc2dzUmVzcG9uc2USRgoFc3dhcHMYASADKAsyKi50ZW5kZXJtaW50LmxpcXVpZGl0eS52MWJldGExLlN3YXBNc2dTdGF0ZUIEyN4fAFIFc3dhcHMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryPoolBatchSwapMsgResponseDescriptor =
    $convert.base64Decode(
        'Ch1RdWVyeVBvb2xCYXRjaFN3YXBNc2dSZXNwb25zZRJECgRzd2FwGAEgASgLMioudGVuZGVybWludC5saXF1aWRpdHkudjFiZXRhMS5Td2FwTXNnU3RhdGVCBMjeHwBSBHN3YXA=');
...
final $typed_data.Uint8List queryPoolBatchDepositMsgsRequestDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeVBvb2xCYXRjaERlcG9zaXRNc2dzUmVxdWVzdBIXCgdwb29sX2lkGAEgASgEUgZwb29sSWQSRgoKcGFnaW5hdGlvbhgCIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryPoolBatchDepositMsgRequestDescriptor =
    $convert.base64Decode(
        'Ch9RdWVyeVBvb2xCYXRjaERlcG9zaXRNc2dSZXF1ZXN0EhcKB3Bvb2xfaWQYASABKARSBnBvb2xJZBIbCgltc2dfaW5kZXgYAiABKARSCG1zZ0luZGV4');
...
const QueryPoolBatchDepositMsgsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.DepositMsgState',
      '8': const {},
      '10': 'deposits'
    },
    const {
...
final $typed_data.Uint8List queryPoolBatchDepositMsgsResponseDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeVBvb2xCYXRjaERlcG9zaXRNc2dzUmVzcG9uc2USTwoIZGVwb3NpdHMYASADKAsyLS50ZW5kZXJtaW50LmxpcXVpZGl0eS52MWJldGExLkRlcG9zaXRNc2dTdGF0ZUIEyN4fAFIIZGVwb3NpdHMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryPoolBatchDepositMsgResponseDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeVBvb2xCYXRjaERlcG9zaXRNc2dSZXNwb25zZRJNCgdkZXBvc2l0GAEgASgLMi0udGVuZGVybWludC5saXF1aWRpdHkudjFiZXRhMS5EZXBvc2l0TXNnU3RhdGVCBMjeHwBSB2RlcG9zaXQ=');
...
final $typed_data.Uint8List queryPoolBatchWithdrawMsgsRequestDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeVBvb2xCYXRjaFdpdGhkcmF3TXNnc1JlcXVlc3QSFwoHcG9vbF9pZBgBIAEoBFIGcG9vbElkEkYKCnBhZ2luYXRpb24YAiABKAsyJi5jb3Ntb3MuYmFzZS5xdWVyeS52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryPoolBatchWithdrawMsgRequestDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeVBvb2xCYXRjaFdpdGhkcmF3TXNnUmVxdWVzdBIXCgdwb29sX2lkGAEgASgEUgZwb29sSWQSGwoJbXNnX2luZGV4GAIgASgEUghtc2dJbmRleA==');
...
const QueryPoolBatchWithdrawMsgsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.tendermint.liquidity.v1beta1.WithdrawMsgState',
      '8': const {},
      '10': 'withdraws'
    },
    const {
...
final $typed_data.Uint8List queryPoolBatchWithdrawMsgsResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List queryPoolBatchWithdrawMsgResponseDescriptor =
    $convert.base64Decode(
        'CiFRdWVyeVBvb2xCYXRjaFdpdGhkcmF3TXNnUmVzcG9uc2USUAoId2l0aGRyYXcYASABKAsyLi50ZW5kZXJtaW50LmxpcXVpZGl0eS52MWJldGExLldpdGhkcmF3TXNnU3RhdGVCBMjeHwBSCHdpdGhkcmF3');
